...
public final class Challenge {
    ...
    public Challenge(String str, Map<String, String> map) {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            if (str3 != null) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(locale, AirshipConfigOptions.SITE_US);
                if (str3 != null) {
    ...
    public final String m1036deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final Charset m1034deprecated_charset() {
        return charset();
    }
