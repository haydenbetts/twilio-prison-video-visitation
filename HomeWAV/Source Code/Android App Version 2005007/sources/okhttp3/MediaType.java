...
public final class MediaType {
    ...
    public final String m1086deprecated_type() {
        return this.type;
    }
    ...
    public final String m1085deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m1087deprecated_get(String str) {
        ...
        public final MediaType m1088deprecated_parse(String str) {
            Intrinsics.checkParameterIsNotNull(str, "mediaType");
            return parse(str);
        }
    }
