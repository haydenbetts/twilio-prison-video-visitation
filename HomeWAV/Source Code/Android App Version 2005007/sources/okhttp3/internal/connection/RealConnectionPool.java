...
public final class RealConnectionPool {
    ...
    public final long cleanup(long r11) {
        /*
            ...
            monitor-enter(r10)
            java.util.ArrayDeque<okhttp3.internal.connection.RealConnection> r1 = r10.connections     // Catch:{ all -> 0x0074 }
            ...
            r3 = 0
        L_0x000f:
            boolean r6 = r1.hasNext()     // Catch:{ all -> 0x0074 }
            if (r6 == 0) goto L_0x0038
            java.lang.Object r6 = r1.next()     // Catch:{ all -> 0x0074 }
            okhttp3.internal.connection.RealConnection r6 = (okhttp3.internal.connection.RealConnection) r6     // Catch:{ all -> 0x0074 }
            java.lang.String r7 = "connection"
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r6, r7)     // Catch:{ all -> 0x0074 }
            int r7 = r10.pruneAndGetAllocationCount(r6, r11)     // Catch:{ all -> 0x0074 }
            if (r7 <= 0) goto L_0x0029
            int r3 = r3 + 1
            goto L_0x000f
        L_0x0029:
            int r2 = r2 + 1
            long r7 = r6.getIdleAtNs$okhttp()     // Catch:{ all -> 0x0074 }
            long r7 = r11 - r7
            ...
            goto L_0x000f
        L_0x0038:
            long r11 = r10.keepAliveDurationNs     // Catch:{ all -> 0x0074 }
            int r1 = (r4 > r11 ? 1 : (r4 == r11 ? 0 : -1))
            if (r1 >= 0) goto L_0x0050
            int r1 = r10.maxIdleConnections     // Catch:{ all -> 0x0074 }
        ...
        L_0x004c:
            ...
            return r11
        L_0x0050:
            java.util.ArrayDeque<okhttp3.internal.connection.RealConnection> r11 = r10.connections     // Catch:{ all -> 0x0074 }
            r11.remove(r0)     // Catch:{ all -> 0x0074 }
            java.util.ArrayDeque<okhttp3.internal.connection.RealConnection> r11 = r10.connections     // Catch:{ all -> 0x0074 }
            boolean r11 = r11.isEmpty()     // Catch:{ all -> 0x0074 }
            if (r11 == 0) goto L_0x0062
            okhttp3.internal.concurrent.TaskQueue r11 = r10.cleanupQueue     // Catch:{ all -> 0x0074 }
            r11.cancelAll()     // Catch:{ all -> 0x0074 }
        L_0x0062:
            kotlin.Unit r11 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0074 }
            monitor-exit(r10)
