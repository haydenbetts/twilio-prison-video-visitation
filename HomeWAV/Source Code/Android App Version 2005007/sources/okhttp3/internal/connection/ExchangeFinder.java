...
public final class ExchangeFinder {
    ...
    private final okhttp3.internal.connection.RealConnection findConnection(int r19, int r20, int r21, int r22, boolean r23) throws java.io.IOException {
        /*
            ...
            monitor-enter(r5)
            okhttp3.internal.connection.RealCall r6 = r1.call     // Catch:{ all -> 0x0220 }
            boolean r6 = r6.isCanceled()     // Catch:{ all -> 0x0220 }
            if (r6 != 0) goto L_0x0216
            okhttp3.internal.connection.RealCall r6 = r1.call     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealConnection r6 = r6.getConnection()     // Catch:{ all -> 0x0220 }
            r4.element = r6     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealCall r6 = r1.call     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealConnection r6 = r6.getConnection()     // Catch:{ all -> 0x0220 }
            ...
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0220 }
        L_0x0034:
            boolean r6 = r6.getNoNewExchanges()     // Catch:{ all -> 0x0220 }
            ...
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0220 }
        L_0x0045:
            okhttp3.Address r7 = r1.address     // Catch:{ all -> 0x0220 }
            okhttp3.HttpUrl r7 = r7.url()     // Catch:{ all -> 0x0220 }
            boolean r6 = r6.supportsUrl(r7)     // Catch:{ all -> 0x0220 }
            if (r6 != 0) goto L_0x0058
        L_0x0051:
            okhttp3.internal.connection.RealCall r6 = r1.call     // Catch:{ all -> 0x0220 }
            java.net.Socket r6 = r6.releaseConnectionNoEvents$okhttp()     // Catch:{ all -> 0x0220 }
            goto L_0x0059
        L_0x0058:
            r6 = r0
        L_0x0059:
            okhttp3.internal.connection.RealCall r7 = r1.call     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealConnection r7 = r7.getConnection()     // Catch:{ all -> 0x0220 }
            if (r7 == 0) goto L_0x006c
            okhttp3.internal.connection.RealCall r2 = r1.call     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealConnection r2 = r2.getConnection()     // Catch:{ all -> 0x0220 }
            r7 = r0
            okhttp3.internal.connection.RealConnection r7 = (okhttp3.internal.connection.RealConnection) r7     // Catch:{ all -> 0x0220 }
            r4.element = r7     // Catch:{ all -> 0x0220 }
        L_0x006c:
            r7 = 1
            r8 = 0
            if (r2 != 0) goto L_0x0094
            r1.refusedStreamCount = r8     // Catch:{ all -> 0x0220 }
            r1.connectionShutdownCount = r8     // Catch:{ all -> 0x0220 }
            r1.otherFailureCount = r8     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealConnectionPool r9 = r1.connectionPool     // Catch:{ all -> 0x0220 }
            okhttp3.Address r10 = r1.address     // Catch:{ all -> 0x0220 }
            okhttp3.internal.connection.RealCall r11 = r1.call     // Catch:{ all -> 0x0220 }
            boolean r9 = r9.callAcquirePooledConnection(r10, r11, r0, r8)     // Catch:{ all -> 0x0220 }
            ...
            goto L_0x0095
        L_0x008a:
            okhttp3.Route r9 = r1.nextRouteToTry     // Catch:{ all -> 0x0220 }
            if (r9 == 0) goto L_0x0094
            r3 = r0
            okhttp3.Route r3 = (okhttp3.Route) r3     // Catch:{ all -> 0x0220 }
            r1.nextRouteToTry = r3     // Catch:{ all -> 0x0220 }
            r3 = r9
        L_0x0094:
            r9 = 0
        L_0x0095:
            kotlin.Unit r10 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0220 }
            monitor-exit(r5)
        ...
        L_0x0109:
            ...
            boolean r10 = r10.isCanceled()     // Catch:{ all -> 0x0213 }
            if (r10 != 0) goto L_0x0209
            if (r4 == 0) goto L_0x0137
            okhttp3.internal.connection.RouteSelector$Selection r4 = r1.routeSelection     // Catch:{ all -> 0x0213 }
            if (r4 != 0) goto L_0x0120
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0213 }
        L_0x0120:
            java.util.List r5 = r4.getRoutes()     // Catch:{ all -> 0x0213 }
            okhttp3.internal.connection.RealConnectionPool r4 = r1.connectionPool     // Catch:{ all -> 0x0213 }
            okhttp3.Address r10 = r1.address     // Catch:{ all -> 0x0213 }
            okhttp3.internal.connection.RealCall r11 = r1.call     // Catch:{ all -> 0x0213 }
            boolean r4 = r4.callAcquirePooledConnection(r10, r11, r5, r8)     // Catch:{ all -> 0x0213 }
            if (r4 == 0) goto L_0x0137
            okhttp3.internal.connection.RealCall r2 = r1.call     // Catch:{ all -> 0x0213 }
            okhttp3.internal.connection.RealConnection r2 = r2.getConnection()     // Catch:{ all -> 0x0213 }
            r9 = 1
        L_0x0137:
            if (r9 != 0) goto L_0x0154
            if (r3 != 0) goto L_0x0146
            okhttp3.internal.connection.RouteSelector$Selection r2 = r1.routeSelection     // Catch:{ all -> 0x0213 }
            if (r2 != 0) goto L_0x0142
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0213 }
        L_0x0142:
            okhttp3.Route r3 = r2.next()     // Catch:{ all -> 0x0213 }
        L_0x0146:
            okhttp3.internal.connection.RealConnection r2 = new okhttp3.internal.connection.RealConnection     // Catch:{ all -> 0x0213 }
            okhttp3.internal.connection.RealConnectionPool r4 = r1.connectionPool     // Catch:{ all -> 0x0213 }
            if (r3 != 0) goto L_0x014f
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0213 }
        L_0x014f:
            r2.<init>(r4, r3)     // Catch:{ all -> 0x0213 }
            r1.connectingConnection = r2     // Catch:{ all -> 0x0213 }
        L_0x0154:
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0213 }
            monitor-exit(r6)
        ...
        L_0x019c:
            ...
            okhttp3.Address r8 = r1.address     // Catch:{ all -> 0x0206 }
            okhttp3.internal.connection.RealCall r9 = r1.call     // Catch:{ all -> 0x0206 }
            boolean r0 = r0.callAcquirePooledConnection(r8, r9, r5, r7)     // Catch:{ all -> 0x0206 }
            if (r0 == 0) goto L_0x01d3
            if (r2 != 0) goto L_0x01be
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0206 }
        L_0x01be:
            r2.setNoNewExchanges(r7)     // Catch:{ all -> 0x0206 }
            if (r2 != 0) goto L_0x01c6
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0206 }
        L_0x01c6:
            java.net.Socket r4 = r2.socket()     // Catch:{ all -> 0x0206 }
            okhttp3.internal.connection.RealCall r0 = r1.call     // Catch:{ all -> 0x0206 }
            okhttp3.internal.connection.RealConnection r2 = r0.getConnection()     // Catch:{ all -> 0x0206 }
            r1.nextRouteToTry = r3     // Catch:{ all -> 0x0206 }
            goto L_0x01e7
        L_0x01d3:
            okhttp3.internal.connection.RealConnectionPool r0 = r1.connectionPool     // Catch:{ all -> 0x0206 }
            ...
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0206 }
        L_0x01da:
            r0.put(r2)     // Catch:{ all -> 0x0206 }
            okhttp3.internal.connection.RealCall r0 = r1.call     // Catch:{ all -> 0x0206 }
            if (r2 != 0) goto L_0x01e4
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0206 }
        L_0x01e4:
            r0.acquireConnectionNoEvents(r2)     // Catch:{ all -> 0x0206 }
        L_0x01e7:
