...
public final class Relay {
    ...
    public final class RelaySource implements Source {
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:94:0x01ba, code lost:
            throw new kotlin.TypeCastException("null cannot be cast to non-null type java.lang.Object");
         */
        ...
        public long read(okio.Buffer r20, long r21) throws java.io.IOException {
            ...
            L_0x0013:
                ...
                monitor-enter(r8)
            L_0x0018:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                long r6 = r0.getUpstreamPos()     // Catch:{ all -> 0x01c7 }
                long r9 = r1.sourcePos     // Catch:{ all -> 0x01c7 }
                r0 = 2
                r11 = -1
                int r13 = (r9 > r6 ? 1 : (r9 == r6 ? 0 : -1))
                if (r13 == 0) goto L_0x0065
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                long r6 = r4.getUpstreamPos()     // Catch:{ all -> 0x01c7 }
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                okio.Buffer r4 = r4.getBuffer()     // Catch:{ all -> 0x01c7 }
                long r9 = r4.size()     // Catch:{ all -> 0x01c7 }
                long r6 = r6 - r9
                long r9 = r1.sourcePos     // Catch:{ all -> 0x01c7 }
            ...
            L_0x0040:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                long r9 = r0.getUpstreamPos()     // Catch:{ all -> 0x01c7 }
                long r11 = r1.sourcePos     // Catch:{ all -> 0x01c7 }
                long r9 = r9 - r11
                long r9 = java.lang.Math.min(r2, r9)     // Catch:{ all -> 0x01c7 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                okio.Buffer r2 = r0.getBuffer()     // Catch:{ all -> 0x01c7 }
                long r3 = r1.sourcePos     // Catch:{ all -> 0x01c7 }
                long r6 = r3 - r6
                r3 = r20
                r4 = r6
                r6 = r9
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x01c7 }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x01c7 }
                long r2 = r2 + r9
                r1.sourcePos = r2     // Catch:{ all -> 0x01c7 }
                monitor-exit(r8)
                return r9
            L_0x0065:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                boolean r6 = r6.getComplete()     // Catch:{ all -> 0x01c7 }
                if (r6 == 0) goto L_0x006f
                monitor-exit(r8)
                return r11
            L_0x006f:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                java.lang.Thread r6 = r6.getUpstreamReader()     // Catch:{ all -> 0x01c7 }
                if (r6 == 0) goto L_0x007f
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x01c7 }
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                r0.waitUntilNotified(r6)     // Catch:{ all -> 0x01c7 }
                goto L_0x0018
            L_0x007f:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                java.lang.Thread r7 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x01c7 }
                r6.setUpstreamReader(r7)     // Catch:{ all -> 0x01c7 }
            L_0x0088:
                monitor-exit(r8)
                r8 = 32
            ...
            L_0x00b0:
                ...
                okio.Source r0 = r0.getUpstream()     // Catch:{ all -> 0x01a4 }
                if (r0 != 0) goto L_0x00bc
                kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x01a4 }
            L_0x00bc:
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a4 }
                okio.Buffer r4 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x01a4 }
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a4 }
                long r6 = r6.getBufferMaxSize()     // Catch:{ all -> 0x01a4 }
                long r14 = r0.read(r4, r6)     // Catch:{ all -> 0x01a4 }
                int r0 = (r14 > r11 ? 1 : (r14 == r11 ? 0 : -1))
                if (r0 != 0) goto L_0x00fb
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a4 }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x01a4 }
                r0.commit(r2)     // Catch:{ all -> 0x01a4 }
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this
                monitor-enter(r2)
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x00f8 }
                java.lang.Thread r10 = (java.lang.Thread) r10     // Catch:{ all -> 0x00f8 }
                r0.setUpstreamReader(r10)     // Catch:{ all -> 0x00f8 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x00f8 }
                if (r0 == 0) goto L_0x00f0
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x00f8 }
                r0.notifyAll()     // Catch:{ all -> 0x00f8 }
            ...
            L_0x00f8:
                ...
                throw r0
            L_0x00fb:
                long r11 = java.lang.Math.min(r14, r2)     // Catch:{ all -> 0x01a4 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a4 }
                okio.Buffer r2 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x01a4 }
                r6 = 0
                r3 = r20
                r4 = r6
                r6 = r11
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x01a4 }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x01a4 }
                long r2 = r2 + r11
                r1.sourcePos = r2     // Catch:{ all -> 0x01a4 }
                okhttp3.internal.cache2.FileOperator r13 = r1.fileOperator     // Catch:{ all -> 0x01a4 }
            ...
            L_0x011a:
                ...
                long r2 = r2 + r8
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a4 }
                okio.Buffer r0 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x01a4 }
                okio.Buffer r16 = r0.clone()     // Catch:{ all -> 0x01a4 }
                r4 = r14
                r14 = r2
                r17 = r4
                r13.write(r14, r16, r17)     // Catch:{ all -> 0x01a4 }
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a4 }
                monitor-enter(r2)     // Catch:{ all -> 0x01a4 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                okio.Buffer r0 = r0.getBuffer()     // Catch:{ all -> 0x01a1 }
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                okio.Buffer r3 = r3.getUpstreamBuffer()     // Catch:{ all -> 0x01a1 }
                r0.write((okio.Buffer) r3, (long) r4)     // Catch:{ all -> 0x01a1 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                okio.Buffer r0 = r0.getBuffer()     // Catch:{ all -> 0x01a1 }
                long r6 = r0.size()     // Catch:{ all -> 0x01a1 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                long r8 = r0.getBufferMaxSize()     // Catch:{ all -> 0x01a1 }
                int r0 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
                if (r0 <= 0) goto L_0x0172
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                okio.Buffer r0 = r0.getBuffer()     // Catch:{ all -> 0x01a1 }
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                okio.Buffer r3 = r3.getBuffer()     // Catch:{ all -> 0x01a1 }
                long r6 = r3.size()     // Catch:{ all -> 0x01a1 }
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                long r8 = r3.getBufferMaxSize()     // Catch:{ all -> 0x01a1 }
                long r6 = r6 - r8
                r0.skip(r6)     // Catch:{ all -> 0x01a1 }
            L_0x0172:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a1 }
                long r6 = r0.getUpstreamPos()     // Catch:{ all -> 0x01a1 }
                long r6 = r6 + r4
                r0.setUpstreamPos(r6)     // Catch:{ all -> 0x01a1 }
                ...
                java.lang.Thread r10 = (java.lang.Thread) r10     // Catch:{ all -> 0x019e }
                r0.setUpstreamReader(r10)     // Catch:{ all -> 0x019e }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                if (r0 == 0) goto L_0x0196
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x019e }
                r0.notifyAll()     // Catch:{ all -> 0x019e }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x019e }
                monitor-exit(r2)
                return r11
            L_0x0196:
            ...
            L_0x01a4:
                ...
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this
                monitor-enter(r2)
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c4 }
                java.lang.Thread r10 = (java.lang.Thread) r10     // Catch:{ all -> 0x01c4 }
                r3.setUpstreamReader(r10)     // Catch:{ all -> 0x01c4 }
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c4 }
                if (r3 != 0) goto L_0x01bb
                kotlin.TypeCastException r0 = new kotlin.TypeCastException     // Catch:{ all -> 0x01c4 }
                java.lang.String r3 = "null cannot be cast to non-null type java.lang.Object"
                r0.<init>(r3)     // Catch:{ all -> 0x01c4 }
                throw r0     // Catch:{ all -> 0x01c4 }
            L_0x01bb:
                java.lang.Object r3 = (java.lang.Object) r3     // Catch:{ all -> 0x01c4 }
                r3.notifyAll()     // Catch:{ all -> 0x01c4 }
                kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x01c4 }
                monitor-exit(r2)
                throw r0
            L_0x01c4:
                r0 = move-exception
    ...
    public static final class Companion {
        ...
        public final Relay edit(File file, Source source, ByteString byteString, long j) throws IOException {
            ...
            Intrinsics.checkParameterIsNotNull(byteString, TtmlNode.TAG_METADATA);
