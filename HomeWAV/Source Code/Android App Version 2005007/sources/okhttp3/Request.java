...
public final class Request {
    ...
    public Request(HttpUrl httpUrl, String str, Headers headers2, RequestBody requestBody, Map<Class<?>, ? extends Object> map) {
        ...
        Intrinsics.checkParameterIsNotNull(map, FetchDeviceInfoAction.TAGS_KEY);
        this.url = httpUrl;
        this.method = str;
    ...
    public final HttpUrl m1127deprecated_url() {
        return this.url;
    }
    ...
    public final String m1126deprecated_method() {
        return this.method;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "headers", imports = {}))
    /* renamed from: -deprecated_headers  reason: not valid java name */
    public final Headers m1125deprecated_headers() {
        return this.headers;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "body", imports = {}))
    /* renamed from: -deprecated_body  reason: not valid java name */
    public final RequestBody m1123deprecated_body() {
        return this.body;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "cacheControl", imports = {}))
    /* renamed from: -deprecated_cacheControl  reason: not valid java name */
    public final CacheControl m1124deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public static class Builder {
        ...
        public Builder get() {
            return method(DefaultHttpClient.METHOD_GET, (RequestBody) null);
        }
