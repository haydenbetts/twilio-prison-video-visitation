...
public class WorkerWrapper implements Runnable {
    ...
    private void resolve(boolean r5) {
        /*
            ...
            r0.beginTransaction()
            androidx.work.impl.WorkDatabase r0 = r4.mWorkDatabase     // Catch:{ all -> 0x0059 }
        ...
        L_0x001c:
            ...
            android.content.Context r0 = r4.mAppContext     // Catch:{ all -> 0x0059 }
        ...
        L_0x0025:
            ...
            androidx.work.impl.model.WorkSpecDao r0 = r4.mWorkSpecDao     // Catch:{ all -> 0x0059 }
            java.lang.String r1 = r4.mWorkSpecId     // Catch:{ all -> 0x0059 }
            r2 = -1
            r0.markWorkSpecScheduled(r1, r2)     // Catch:{ all -> 0x0059 }
        L_0x0030:
            androidx.work.impl.model.WorkSpec r0 = r4.mWorkSpec     // Catch:{ all -> 0x0059 }
            if (r0 == 0) goto L_0x0045
            androidx.work.ListenableWorker r0 = r4.mWorker     // Catch:{ all -> 0x0059 }
            if (r0 == 0) goto L_0x0045
            boolean r0 = r0.isRunInForeground()     // Catch:{ all -> 0x0059 }
            if (r0 == 0) goto L_0x0045
            androidx.work.impl.foreground.ForegroundProcessor r0 = r4.mForegroundProcessor     // Catch:{ all -> 0x0059 }
            java.lang.String r1 = r4.mWorkSpecId     // Catch:{ all -> 0x0059 }
