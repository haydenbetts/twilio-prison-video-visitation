...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void CGEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 63, i4, 0, 0, 0, 0, y, x, 0, float23.x, float23.y, id, id2, float24.x, float24.y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 71, i4, 0, 0, 0, 0, y, x, 0, double23.x, double23.y, id, id2, double24.x, double24.y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGBMV(int i, int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, int i4, Float2 float22, Allocation allocation3, int i5) {
        ...
        int i6 = i;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 64, i6, 0, 0, 0, 0, y, x, 0, float23.x, float23.y, id, id2, float24.x, float24.y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void ZGBMV(int i, int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, int i4, Double2 double22, Allocation allocation3, int i5) {
        ...
        int i6 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 72, i6, 0, 0, 0, 0, y, x, 0, double23.x, double23.y, id, id2, double24.x, double24.y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void CHEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 95, 0, 0, 0, i4, 0, 0, validateSYR2, 0, float23.x, float23.y, id, id2, float24.x, float24.y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHBMV(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, int i3, Float2 float22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            int i5 = i;
            int i6 = i2;
            this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 96, 0, 0, 0, i5, 0, 0, validateSYR2, i6, float23.x, float23.y, id, id2, float24.x, float24.y, id3, i3, i4, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CHPMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 97, 0, 0, 0, i4, 0, 0, validateSPR2, 0, float23.x, float23.y, id, id2, float24.x, float24.y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 104, 0, 0, 0, i4, 0, 0, validateSYR2, 0, double23.x, double23.y, id, id2, double24.x, double24.y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHBMV(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, int i3, Double2 double22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            int i5 = i;
            int i6 = i2;
            this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 105, 0, 0, 0, i5, 0, 0, validateSYR2, i6, double23.x, double23.y, id, id2, double24.x, double24.y, id3, i3, i4, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be 0 or greater for HBMV");
    }
    ...
    public void ZHPMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 106, 0, 0, 0, i4, 0, 0, validateSPR2, 0, double23.x, double23.y, id, id2, double24.x, double24.y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id2;
        long j2 = id3;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 107, 0, 0, 0, 0, 0, y, x, 0, double22.x, double22.y, j, j2, 0.0d, 0.0d, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id2;
        long j2 = id3;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 108, 0, 0, 0, 0, 0, y, x, 0, double22.x, double22.y, j, j2, 0.0d, 0.0d, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j2 = id3;
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 111, 0, 0, 0, i4, 0, 0, validateSYR2, 0, double22.x, double22.y, j, j2, 0.0d, 0.0d, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j2 = id3;
        int i4 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 112, 0, 0, 0, i4, 0, 0, validateSPR2, 0, double22.x, double22.y, j, j2, 0.0d, 0.0d, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 125, i, i2, 0, 0, 0, i7, i9, i8, float23.x, float23.y, j3, j2, float24.x, float24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 131, i, i2, 0, 0, 0, i7, i9, i8, double23.x, double23.y, j3, j2, double24.x, double24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 126, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.x, float23.y, id, id2, float24.x, float24.y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void ZSYMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 132, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.x, double23.y, id, id2, double24.x, double24.y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        int i6 = i2;
        int i7 = i;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 127, i6, 0, 0, i7, 0, 0, allocation2.getType().getX(), i5, float23.x, float23.y, id, 0, float24.x, float24.y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        int i6 = i2;
        int i7 = i;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 133, i6, 0, 0, i7, 0, 0, allocation2.getType().getX(), i5, double23.x, double23.y, id, 0, double24.x, double24.y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYR2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 128, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, float23.x, float23.y, j3, j2, float24.x, float24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYR2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 134, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, double23.x, double23.y, j3, j2, double24.x, double24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 129, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.x, float22.y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 135, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.x, double22.y, id, j, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 130, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.x, float22.y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 136, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.x, double22.y, id, j, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 137, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.x, float23.y, j3, j2, float24.x, float24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 140, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.x, double23.y, j3, j2, double24.x, double24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 139, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, float22.x, float22.y, allocation4.getID(this.mRS), j2, f, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 142, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, double22.x, double22.y, allocation4.getID(this.mRS), j2, d, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
