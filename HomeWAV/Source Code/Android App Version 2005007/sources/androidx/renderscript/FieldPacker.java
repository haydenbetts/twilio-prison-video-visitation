...
public class FieldPacker {
    ...
    public short subI16() {
        ...
        int i2 = i - 1;
        this.mPos = i2;
        return (short) (((short) (bArr[i2] & UByte.MAX_VALUE)) | ((short) ((bArr[i] & UByte.MAX_VALUE) << 8)));
    }
    ...
    public int subI32() {
        ...
        int i4 = i3 - 1;
        this.mPos = i4;
        return (bArr[i4] & UByte.MAX_VALUE) | ((bArr[i] & UByte.MAX_VALUE) << 24) | ((bArr[i2] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH) | ((bArr[i3] & UByte.MAX_VALUE) << 8);
    }
