...
public class ProjectiveTransformerCL extends ProjectiveTransformer implements ImageTransformerCL {
    ...
    public ProjectiveTransformerCL(JavaCVCL javaCVCL) {
        this(javaCVCL, (CvMat) null, (CvMat) null, (CvMat) null, (CvMat) null, (CvMat) null, new double[0], (double[]) null);
    }

    public ProjectiveTransformerCL(JavaCVCL javaCVCL, double[] dArr) {
        this(javaCVCL, (CvMat) null, (CvMat) null, (CvMat) null, (CvMat) null, (CvMat) null, dArr, (double[]) null);
    }

    public ProjectiveTransformerCL(JavaCVCL javaCVCL, ProjectiveDevice projectiveDevice, ProjectiveDevice projectiveDevice2, CvMat cvMat, double[] dArr, double[] dArr2) {
    ...
    public ProjectiveTransformerCL(JavaCVCL javaCVCL, CvMat cvMat, CvMat cvMat2, CvMat cvMat3, CvMat cvMat4, CvMat cvMat5, double[] dArr, double[] dArr2) {
    ...
    public void transform(CLImage2d cLImage2d, CLImage2d cLImage2d2, CLImage2d cLImage2d3, CLImage2d cLImage2d4, CLImage2d cLImage2d5, CLImage2d cLImage2d6, ImageTransformer.Parameters[] parametersArr, boolean[] zArr, ImageTransformerCL.InputData inputData, ImageTransformerCL.OutputData outputData) {
        ...
        prepareHomographies(this.HBuffer, inputData2.pyramidLevel, parametersArr2, zArr);
        ...
        if (cLImage2d8 == null) {
            ...
            cLKernel = putArg.putArg(cLImage2d10).putArg(cLImage2d11).putArg(this.HBuffer).putArg(buffer).putArg(buffer2).rewind();
        } else if (cLImage2d9 == null) {
            cLKernel = this.subKernel.putArg(cLImage2d7).putArg(cLImage2d8).putArg(cLImage2d4).putArg(cLImage2d10).putArg(cLImage2d11).putArg(this.HBuffer).putArg(buffer).putArg(buffer2).rewind();
        } else {
            cLKernel = this.dotKernel.putArg(cLImage2d7).putArg(cLImage2d8).putArg(cLImage2d9).putArg(cLImage2d11).putArg(this.HBuffer).putArg(buffer).putArg(buffer2).rewind();
        }
