...
public class CvHaarFeatureParams extends CvFeatureParams {
    ...
    public CvHaarFeatureParams(long j) {
        super((Pointer) null);
        allocateArray(j);
    }

    public CvHaarFeatureParams position(long j) {
        return (CvHaarFeatureParams) super.position(j);
    }

    public CvHaarFeatureParams getPointer(long j) {
        return new CvHaarFeatureParams((Pointer) this).position(this.position + j);
    }
