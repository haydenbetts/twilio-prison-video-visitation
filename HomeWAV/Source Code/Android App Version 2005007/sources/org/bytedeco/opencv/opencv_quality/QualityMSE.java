...
public class QualityMSE extends QualityBase {
    ...
    @opencv_core.Ptr
    public static native QualityMSE create(@ByVal GpuMat gpuMat);

    @opencv_core.Ptr
    public static native QualityMSE create(@ByVal Mat mat);

    @opencv_core.Ptr
    public static native QualityMSE create(@ByVal UMat uMat);
    ...
    public QualityMSE(Pointer pointer) {
        super(pointer);
    }
}
