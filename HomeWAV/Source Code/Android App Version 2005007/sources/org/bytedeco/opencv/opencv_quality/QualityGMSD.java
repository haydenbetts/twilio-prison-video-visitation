...
public class QualityGMSD extends QualityBase {
    ...
    @opencv_core.Ptr
    public static native QualityGMSD create(@ByVal GpuMat gpuMat);

    @opencv_core.Ptr
    public static native QualityGMSD create(@ByVal Mat mat);

    @opencv_core.Ptr
    public static native QualityGMSD create(@ByVal UMat uMat);
    ...
    public QualityGMSD(Pointer pointer) {
        super(pointer);
    }
}
