...
public class DisparityFilter extends Algorithm {
    ...
    public native void filter(@ByVal GpuMat gpuMat, @ByVal GpuMat gpuMat2, @ByVal GpuMat gpuMat3, @ByVal(nullValue = "cv::InputArray(cv::Mat())") GpuMat gpuMat4, @ByVal(nullValue = "cv::Rect()") Rect rect, @ByVal(nullValue = "cv::InputArray(cv::Mat())") GpuMat gpuMat5);
    ...
    public DisparityFilter(Pointer pointer) {
        super(pointer);
    }
}
