...
@Properties(global = "org.bytedeco.opencv.global.opencv_tracking", inherit = {opencv_plot.class, opencv_video.class, opencv_dnn.class}, target = "org.bytedeco.opencv.opencv_tracking", value = {@Platform(include = {"<opencv2/tracking.hpp>", "<opencv2/tracking/feature.hpp>", "<opencv2/tracking/kalman_filters.hpp>", "<opencv2/tracking/onlineMIL.hpp>", "<opencv2/tracking/onlineBoosting.hpp>", "<opencv2/tracking/tldDataset.hpp>", "<opencv2/tracking/tracker.hpp>"}, link = {"opencv_tracking@.4.4"}), @Platform(preload = {"libopencv_tracking"}, value = {"ios"}), @Platform(link = {"opencv_tracking440"}, value = {"windows"})})
