...
public final class BigEndianConversions {
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        int i6 = i5 + 1;
        int i7 = i6 + 1;
        long j = ((((long) bArr[i]) & 255) << 56) | ((((long) bArr[i2]) & 255) << 48) | ((((long) bArr[i3]) & 255) << 40) | ((((long) bArr[i4]) & 255) << 32) | ((255 & ((long) bArr[i5])) << 24) | ((long) ((bArr[i6] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH));
        return ((long) (bArr[i7 + 1] & UByte.MAX_VALUE)) | j | ((long) ((bArr[i7] & UByte.MAX_VALUE) << 8));
    }
