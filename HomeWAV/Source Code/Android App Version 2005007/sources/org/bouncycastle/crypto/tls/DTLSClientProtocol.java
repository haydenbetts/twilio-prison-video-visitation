...
public class DTLSClientProtocol extends DTLSProtocol {
    ...
    public void cancel() throws Exception {
        ...
        if (dTLSRecordLayer != null) {
            dTLSRecordLayer.close();
        }
    }
    ...
    public DTLSTransport connect(TlsClient tlsClient, DatagramTransport datagramTransport) throws IOException {
        ...
        if (tlsClient == null) {
            ...
            this.recordLayer = new DTLSRecordLayer(datagramTransport, clientHandshakeState.clientContext, tlsClient, 22);
            ...
            try {
                return clientHandshake(clientHandshakeState, this.recordLayer);
