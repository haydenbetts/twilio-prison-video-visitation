...
public class Keccak {
    ...
    public static class Digest288 extends DigestKeccak {
        public Digest288() {
            super(VideoDimensions.CIF_VIDEO_HEIGHT);
        }
    }
    ...
    public static class HashMac288 extends BaseMac {
        public HashMac288() {
            super(new HMac(new KeccakDigest((int) VideoDimensions.CIF_VIDEO_HEIGHT)));
        }
    }
    ...
    public static class KeyGenerator288 extends BaseKeyGenerator {
        public KeyGenerator288() {
            super("HMACKECCAK288", VideoDimensions.CIF_VIDEO_HEIGHT, new CipherKeyGenerator());
        }
    }
