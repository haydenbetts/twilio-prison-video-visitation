...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    private int[] parseIPv6(String str) {
        StringTokenizer stringTokenizer = new StringTokenizer(str, Constants.COMMON_SCHEMA_PREFIX_SEPARATOR, true);
        int[] iArr = new int[8];
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (nextToken.equals(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR)) {
                iArr[i2] = 0;
                int i3 = i2;
                i2++;
                i = i3;
