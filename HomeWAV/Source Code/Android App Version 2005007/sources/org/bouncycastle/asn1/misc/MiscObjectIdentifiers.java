...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        cryptlib_algorithm_blowfish_ECB = branch.branch(BuildConfig.VERSION_NAME);
        cryptlib_algorithm_blowfish_CBC = branch.branch("1.2");
        cryptlib_algorithm_blowfish_CFB = branch.branch(com.thoughtbot.expandablerecyclerview.BuildConfig.VERSION_NAME);
