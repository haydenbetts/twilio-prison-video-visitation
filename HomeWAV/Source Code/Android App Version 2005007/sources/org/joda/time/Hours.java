...
public final class Hours extends BaseSingleFieldPeriod {
    ...
    public static Hours standardHoursIn(ReadablePeriod readablePeriod) {
        return hours(BaseSingleFieldPeriod.standardPeriodIn(readablePeriod, TagGroupLookupResponseCache.DEFAULT_STALE_READ_TIME_MS));
    }
    ...
    public Duration toStandardDuration() {
        return new Duration(((long) getValue()) * TagGroupLookupResponseCache.DEFAULT_STALE_READ_TIME_MS);
    }
