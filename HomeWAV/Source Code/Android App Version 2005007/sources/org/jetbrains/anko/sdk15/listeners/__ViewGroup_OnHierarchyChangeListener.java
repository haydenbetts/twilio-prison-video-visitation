...
public final class __ViewGroup_OnHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
    ...
    public void onChildViewAdded(View view, View view2) {
        ...
        if (function2 != null) {
            Unit invoke = function2.invoke(view, view2);
        }
    }

    public final void onChildViewAdded(Function2<? super View, ? super View, Unit> function2) {
    ...
    public final void onChildViewRemoved(Function2<? super View, ? super View, Unit> function2) {
        Intrinsics.checkParameterIsNotNull(function2, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
