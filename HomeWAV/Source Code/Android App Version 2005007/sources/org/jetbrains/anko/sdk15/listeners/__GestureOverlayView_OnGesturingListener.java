...
public final class __GestureOverlayView_OnGesturingListener implements GestureOverlayView.OnGesturingListener {
    ...
    public void onGesturingStarted(GestureOverlayView gestureOverlayView) {
        ...
        if (function1 != null) {
            Unit invoke = function1.invoke(gestureOverlayView);
        }
    }

    public final void onGesturingStarted(Function1<? super GestureOverlayView, Unit> function1) {
    ...
    public final void onGesturingEnded(Function1<? super GestureOverlayView, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(function1, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
