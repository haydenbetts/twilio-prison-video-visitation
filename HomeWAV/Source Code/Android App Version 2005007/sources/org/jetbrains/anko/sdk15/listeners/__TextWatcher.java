...
public final class __TextWatcher implements TextWatcher {
    ...
    public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (function4 != null) {
            Unit invoke = function4.invoke(charSequence, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
        }
    }

    public final void beforeTextChanged(Function4<? super CharSequence, ? super Integer, ? super Integer, ? super Integer, Unit> function4) {
    ...
    public final void onTextChanged(Function4<? super CharSequence, ? super Integer, ? super Integer, ? super Integer, Unit> function4) {
        Intrinsics.checkParameterIsNotNull(function4, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (function1 != null) {
            Unit invoke = function1.invoke(editable);
        }
    }

    public final void afterTextChanged(Function1<? super Editable, Unit> function1) {
