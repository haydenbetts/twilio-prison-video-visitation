...
public final class __SeekBar_OnSeekBarChangeListener implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
        ...
        if (function3 != null) {
            Unit invoke = function3.invoke(seekBar, Integer.valueOf(i), Boolean.valueOf(z));
        }
    }

    public final void onProgressChanged(Function3<? super SeekBar, ? super Integer, ? super Boolean, Unit> function3) {
    ...
    public void onStartTrackingTouch(SeekBar seekBar) {
        ...
        if (function1 != null) {
            Unit invoke = function1.invoke(seekBar);
        }
    }

    public final void onStartTrackingTouch(Function1<? super SeekBar, Unit> function1) {
    ...
    public final void onStopTrackingTouch(Function1<? super SeekBar, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(function1, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
