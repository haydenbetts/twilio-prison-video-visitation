...
public final class __AdapterView_OnItemSelectedListener implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        if (function4 != null) {
            Unit invoke = function4.invoke(adapterView, view, Integer.valueOf(i), Long.valueOf(j));
        }
    }

    public final void onItemSelected(Function4<? super AdapterView<?>, ? super View, ? super Integer, ? super Long, Unit> function4) {
    ...
    public void onNothingSelected(AdapterView<?> adapterView) {
        ...
        if (function1 != null) {
            Unit invoke = function1.invoke(adapterView);
        }
    }

    public final void onNothingSelected(Function1<? super AdapterView<?>, Unit> function1) {
