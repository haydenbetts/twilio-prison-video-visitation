...
public final class __AbsListView_OnScrollListener implements AbsListView.OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView absListView, int i) {
        ...
        if (function2 != null) {
            Unit invoke = function2.invoke(absListView, Integer.valueOf(i));
        }
    }

    public final void onScrollStateChanged(Function2<? super AbsListView, ? super Integer, Unit> function2) {
    ...
    public void onScroll(AbsListView absListView, int i, int i2, int i3) {
        ...
        if (function4 != null) {
            Unit invoke = function4.invoke(absListView, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
        }
    }

    public final void onScroll(Function4<? super AbsListView, ? super Integer, ? super Integer, ? super Integer, Unit> function4) {
