...
public final class Sdk27ServicesKt {
    ...
    public static final CameraManager getCameraManager(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "receiver$0");
        Object systemService = context.getSystemService(AvatarUpdaterDialog.CAMERA);
        if (systemService != null) {
    ...
    public static final InputManager getInputManager(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "receiver$0");
        Object systemService = context.getSystemService(GraphQLConstants.Keys.INPUT);
        if (systemService != null) {
    ...
    public static final TelephonyManager getTelephonyManager(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "receiver$0");
        Object systemService = context.getSystemService(ShippingInfoWidget.PHONE_FIELD);
        if (systemService != null) {
