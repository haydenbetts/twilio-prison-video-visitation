...
public final class __TextWatcher implements TextWatcher {
    ...
    public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (function6 != null) {
            ...
            Job unused = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, coroutineContext, (CoroutineStart) null, new __TextWatcher$beforeTextChanged$1(function6, charSequence, i, i2, i3, (Continuation) null), 2, (Object) null);
        }
    }
    ...
    public final void beforeTextChanged(Function6<? super CoroutineScope, ? super CharSequence, ? super Integer, ? super Integer, ? super Integer, ? super Continuation<? super Unit>, ? extends Object> function6) {
        Intrinsics.checkParameterIsNotNull(function6, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (function6 != null) {
            CoroutineContext coroutineContext = this.context;
            Job unused = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, coroutineContext, (CoroutineStart) null, new __TextWatcher$onTextChanged$1(function6, charSequence, i, i2, i3, (Continuation) null), 2, (Object) null);
        }
    }
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (function3 != null) {
            Job unused = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, this.context, (CoroutineStart) null, new __TextWatcher$afterTextChanged$1(function3, editable, (Continuation) null), 2, (Object) null);
        }
    }
