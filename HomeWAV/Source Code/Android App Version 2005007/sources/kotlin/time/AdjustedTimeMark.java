...
final class AdjustedTimeMark extends TimeMark {
    ...
    public TimeMark m955plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m982plusLRDsOJo(this.adjustment, d), (DefaultConstructorMarker) null);
    }
}
