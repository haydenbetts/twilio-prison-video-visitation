...
public final class DurationKt {
    ...
    private static final double m1003timesmvk6XK0(int i, double d) {
        return Duration.m985timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1002timeskIfJnKk(double d, double d2) {
        return Duration.m984timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m958constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
