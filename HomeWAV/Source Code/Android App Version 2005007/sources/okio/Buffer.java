...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer readFrom(InputStream inputStream) throws IOException {
        Intrinsics.checkParameterIsNotNull(inputStream, GraphQLConstants.Keys.INPUT);
    ...
    public final byte m1147deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m1148deprecated_size() {
        return this.size;
    }
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        if (j >= 100000000) {
            ...
            i2 = j < C.MICROS_PER_SECOND ? j < 100000 ? 5 : 6 : j < 10000000 ? 7 : 8;
        } else if (j >= 100) {
            i2 = j < 1000 ? 3 : 4;
        } else if (j >= 10) {
            i2 = 2;
