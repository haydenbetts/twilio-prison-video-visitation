...
public final class BufferKt {
    ...
    public static final int commonReadInt(Buffer buffer) {
        ...
        if (buffer.size() >= 4) {
            ...
            int i2 = segment.limit;
            if (((long) (i2 - i)) < 4) {
                return (buffer.readByte() & UByte.MAX_VALUE) | ((buffer.readByte() & UByte.MAX_VALUE) << 24) | ((buffer.readByte() & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH) | ((buffer.readByte() & UByte.MAX_VALUE) << 8);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
