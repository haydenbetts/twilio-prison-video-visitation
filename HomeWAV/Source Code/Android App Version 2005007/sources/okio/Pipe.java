...
public final class Pipe {
    ...
    public final void fold(okio.Sink r8) throws java.io.IOException {
        ...
        L_0x0005:
            ...
            monitor-enter(r0)
            okio.Sink r1 = r7.foldedSink     // Catch:{ all -> 0x0081 }
            r2 = 1
        ...
        L_0x0010:
            ...
            okio.Buffer r1 = r7.buffer     // Catch:{ all -> 0x0081 }
            boolean r1 = r1.exhausted()     // Catch:{ all -> 0x0081 }
            if (r1 == 0) goto L_0x0020
            r7.sourceClosed = r2     // Catch:{ all -> 0x0081 }
            r7.foldedSink = r8     // Catch:{ all -> 0x0081 }
            monitor-exit(r0)
            return
        L_0x0020:
            boolean r1 = r7.sinkClosed     // Catch:{ all -> 0x0081 }
            okio.Buffer r3 = new okio.Buffer     // Catch:{ all -> 0x0081 }
            r3.<init>()     // Catch:{ all -> 0x0081 }
            okio.Buffer r4 = r7.buffer     // Catch:{ all -> 0x0081 }
            long r5 = r4.size()     // Catch:{ all -> 0x0081 }
            r3.write((okio.Buffer) r4, (long) r5)     // Catch:{ all -> 0x0081 }
            okio.Buffer r4 = r7.buffer     // Catch:{ all -> 0x0081 }
            if (r4 == 0) goto L_0x006b
            java.lang.Object r4 = (java.lang.Object) r4     // Catch:{ all -> 0x0081 }
            r4.notifyAll()     // Catch:{ all -> 0x0081 }
        ...
        L_0x004d:
            ...
            okio.Buffer r0 = r7.buffer
            monitor-enter(r0)
            r7.sourceClosed = r2     // Catch:{ all -> 0x0068 }
            okio.Buffer r1 = r7.buffer     // Catch:{ all -> 0x0068 }
            if (r1 != 0) goto L_0x005f
            kotlin.TypeCastException r8 = new kotlin.TypeCastException     // Catch:{ all -> 0x0068 }
        ...
        L_0x005f:
            java.lang.Object r1 = (java.lang.Object) r1     // Catch:{ all -> 0x0068 }
            r1.notifyAll()     // Catch:{ all -> 0x0068 }
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0068 }
            monitor-exit(r0)
            throw r8
        L_0x0068:
            r8 = move-exception
            ...
            throw r8
        L_0x006b:
            kotlin.TypeCastException r8 = new kotlin.TypeCastException     // Catch:{ all -> 0x0081 }
            java.lang.String r1 = "null cannot be cast to non-null type java.lang.Object"
            r8.<init>(r1)     // Catch:{ all -> 0x0081 }
            throw r8     // Catch:{ all -> 0x0081 }
        L_0x0073:
            java.lang.String r8 = "sink already folded"
            java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0081 }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x0081 }
            r1.<init>(r8)     // Catch:{ all -> 0x0081 }
            java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x0081 }
    ...
    public final Sink m1163deprecated_sink() {
        return this.sink;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "source", imports = {}))
    /* renamed from: -deprecated_source  reason: not valid java name */
    public final Source m1164deprecated_source() {
        return this.source;
    }
}
