...
final class zzd extends zza {
    ...
    /* compiled from: com.google.android.datatransport:transport-backend-cct@@2.2.0 */
    static final class zza extends zza.C0000zza {
        private Integer zza;
        private String zzb;
        private String zzc;
        private String zzd;
        ...
        public zza.C0000zza zza(int i) {
            this.zza = Integer.valueOf(i);
            return this;
        }

        public zza.C0000zza zzb(String str) {
            this.zzh = str;
            return this;
        }

        public zza.C0000zza zzc(String str) {
            this.zzc = str;
            return this;
        }

        public zza.C0000zza zzd(String str) {
            this.zzg = str;
            return this;
        }

        public zza.C0000zza zze(String str) {
            this.zzb = str;
            return this;
        }

        public zza.C0000zza zzf(String str) {
            this.zzf = str;
            return this;
        }

        public zza.C0000zza zzg(String str) {
            this.zze = str;
            return this;
        }

        public zza.C0000zza zza(String str) {
            this.zzd = str;
            return this;
        }
