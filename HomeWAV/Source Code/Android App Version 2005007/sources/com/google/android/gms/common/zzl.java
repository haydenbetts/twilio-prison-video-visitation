...
class zzl {
    ...
    static String zza(String str, zzd zzd2, boolean z, boolean z2) {
        ...
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", new Object[]{str2, str, Hex.bytesToStringLowercase(((MessageDigest) Preconditions.checkNotNull(AndroidUtilsLight.zza(McElieceCCA2KeyGenParameterSpec.SHA1))).digest(zzd2.zza())), Boolean.valueOf(z), sb.toString()});
    }
}
