    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            for (Api next : this.zak.keySet()) {
                ...
                zap zap2 = new zap(next, z2);
                arrayList.add(zap2);
                Api.AbstractClientBuilder abstractClientBuilder = (Api.AbstractClientBuilder) Preconditions.checkNotNull(next.zab());
                Api api2 = next;
                Api.Client buildClient = abstractClientBuilder.buildClient(this.zaj, this.zao, buildClientSettings, apiOptions, (ConnectionCallbacks) zap2, (OnConnectionFailedListener) zap2);
