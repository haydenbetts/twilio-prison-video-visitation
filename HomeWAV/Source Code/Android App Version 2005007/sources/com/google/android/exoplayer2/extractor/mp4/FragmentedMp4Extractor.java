...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    private static Pair<Long, ChunkIndex> parseSidx(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        long j4 = j3;
        long j5 = j + j2;
        long scaleLargeTimestamp = Util.scaleLargeTimestamp(j4, C.MICROS_PER_SECOND, readUnsignedInt);
        ...
        while (i < readUnsignedShort) {
            ...
            if ((readInt & Integer.MIN_VALUE) == 0) {
                ...
                int[] iArr2 = iArr;
                long scaleLargeTimestamp2 = Util.scaleLargeTimestamp(j8, C.MICROS_PER_SECOND, readUnsignedInt);
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (this.parserState == 3) {
            ...
            if (this.currentTrackBundle.fragment.definesEncryptionData) {
                int appendSampleEncryptionData = appendSampleEncryptionData(this.currentTrackBundle);
