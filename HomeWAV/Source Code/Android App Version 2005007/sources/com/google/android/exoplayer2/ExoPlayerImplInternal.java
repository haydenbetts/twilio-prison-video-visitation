...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.Listener, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    private void seekToInternal(com.google.android.exoplayer2.ExoPlayerImplInternal.SeekPosition r21) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x005c:
            r9 = 2
            com.google.android.exoplayer2.source.MediaSource r10 = r1.mediaSource     // Catch:{ all -> 0x00db }
        ...
        L_0x0066:
            ...
            goto L_0x00c9
        L_0x0072:
            com.google.android.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00db }
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r0 = r0.periodId     // Catch:{ all -> 0x00db }
            boolean r0 = r15.equals(r0)     // Catch:{ all -> 0x00db }
            if (r0 == 0) goto L_0x00b8
            com.google.android.exoplayer2.MediaPeriodQueue r0 = r1.queue     // Catch:{ all -> 0x00db }
            com.google.android.exoplayer2.MediaPeriodHolder r0 = r0.getPlayingPeriod()     // Catch:{ all -> 0x00db }
            if (r0 == 0) goto L_0x0091
            int r7 = (r12 > r4 ? 1 : (r12 == r4 ? 0 : -1))
            if (r7 == 0) goto L_0x0091
            com.google.android.exoplayer2.source.MediaPeriod r0 = r0.mediaPeriod     // Catch:{ all -> 0x00db }
            com.google.android.exoplayer2.SeekParameters r4 = r1.seekParameters     // Catch:{ all -> 0x00db }
            long r4 = r0.getAdjustedSeekPositionUs(r12, r4)     // Catch:{ all -> 0x00db }
            goto L_0x0092
        L_0x0091:
            r4 = r12
        L_0x0092:
            long r7 = com.google.android.exoplayer2.C.usToMs(r4)     // Catch:{ all -> 0x00db }
            com.google.android.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00db }
            long r10 = r0.positionUs     // Catch:{ all -> 0x00db }
            long r10 = com.google.android.exoplayer2.C.usToMs(r10)     // Catch:{ all -> 0x00db }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:73:0x009c A[EDGE_INSN: B:59:0x009c->B:73:0x009c ?: BREAK  
    EDGE_INSN: B:60:0x009c->B:73:0x009c ?: BREAK  
    EDGE_INSN: B:61:0x009c->B:73:0x009c ?: BREAK  
    EDGE_INSN: B:62:0x009c->B:73:0x009c ?: BREAK  , SYNTHETIC] */
