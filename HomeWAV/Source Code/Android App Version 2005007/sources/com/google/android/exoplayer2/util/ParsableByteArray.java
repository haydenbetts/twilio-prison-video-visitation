...
public final class ParsableByteArray {
    ...
    public int readUnsignedInt24() {
        ...
        int i2 = i + 1;
        this.position = i2;
        int i3 = (bArr[i] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH;
        int i4 = i2 + 1;
        this.position = i4;
        byte b = i3 | ((bArr[i2] & UByte.MAX_VALUE) << 8);
        this.position = i4 + 1;
        return (bArr[i4] & UByte.MAX_VALUE) | b;
    }
    ...
    public int readLittleEndianInt24() {
        ...
        this.position = i3 + 1;
        return ((bArr[i3] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH) | b2;
    }
