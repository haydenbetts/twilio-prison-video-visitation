    ...
    static class Token {
        ...
        static Token parse(String str) {
            ...
            try {
                ...
                return new Token(jSONObject.getString("token"), jSONObject.getString("appVersion"), jSONObject.getLong(MessageCenterDataManager.MessageTable.COLUMN_NAME_TIMESTAMP));
        ...
        static String encode(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(MessageCenterDataManager.MessageTable.COLUMN_NAME_TIMESTAMP, j);
