...
public final class CommonNotificationBuilder {
    ...
    private static Uri getSound(String str, NotificationParams notificationParams, Resources resources) {
        ...
        if (InAppMessage.DISPLAY_BEHAVIOR_DEFAULT.equals(soundResourceName) || resources.getIdentifier(soundResourceName, "raw", str) == 0) {
    ...
    private static String getOrCreateChannel(Context context, String str, Bundle bundle) {
        ...
        try {
            ...
            if (notificationManager.getNotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL) == null) {
                notificationManager.createNotificationChannel(new NotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL, context.getString(context.getResources().getIdentifier(FCM_FALLBACK_NOTIFICATION_CHANNEL_LABEL, StringTypedProperty.TYPE, context.getPackageName())), 3));
            }
