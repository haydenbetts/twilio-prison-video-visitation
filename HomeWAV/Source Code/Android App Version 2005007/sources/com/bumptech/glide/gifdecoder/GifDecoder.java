...
public class GifDecoder {
    ...
    public synchronized android.graphics.Bitmap getNextFrame() {
        /*
            r7 = this;
            monitor-enter(r7)
            com.bumptech.glide.gifdecoder.GifHeader r0 = r7.header     // Catch:{ all -> 0x00bd }
            int r0 = r0.frameCount     // Catch:{ all -> 0x00bd }
            r1 = 3
            r2 = 1
            if (r0 <= 0) goto L_0x000d
            int r0 = r7.framePointer     // Catch:{ all -> 0x00bd }
            if (r0 >= 0) goto L_0x003a
        L_0x000d:
            java.lang.String r0 = TAG     // Catch:{ all -> 0x00bd }
            boolean r3 = android.util.Log.isLoggable(r0, r1)     // Catch:{ all -> 0x00bd }
            ...
            com.bumptech.glide.gifdecoder.GifHeader r4 = r7.header     // Catch:{ all -> 0x00bd }
            int r4 = r4.frameCount     // Catch:{ all -> 0x00bd }
            r3.append(r4)     // Catch:{ all -> 0x00bd }
            java.lang.String r4 = " framePointer="
            r3.append(r4)     // Catch:{ all -> 0x00bd }
            int r4 = r7.framePointer     // Catch:{ all -> 0x00bd }
            r3.append(r4)     // Catch:{ all -> 0x00bd }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x00bd }
            android.util.Log.d(r0, r3)     // Catch:{ all -> 0x00bd }
        L_0x0038:
            r7.status = r2     // Catch:{ all -> 0x00bd }
        L_0x003a:
            int r0 = r7.status     // Catch:{ all -> 0x00bd }
            r3 = 0
        ...
        L_0x0043:
            r0 = 0
            r7.status = r0     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.gifdecoder.GifHeader r4 = r7.header     // Catch:{ all -> 0x00bd }
            java.util.List<com.bumptech.glide.gifdecoder.GifFrame> r4 = r4.frames     // Catch:{ all -> 0x00bd }
            int r5 = r7.framePointer     // Catch:{ all -> 0x00bd }
            java.lang.Object r4 = r4.get(r5)     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.gifdecoder.GifFrame r4 = (com.bumptech.glide.gifdecoder.GifFrame) r4     // Catch:{ all -> 0x00bd }
            int r5 = r7.framePointer     // Catch:{ all -> 0x00bd }
            int r5 = r5 - r2
            if (r5 < 0) goto L_0x0062
            com.bumptech.glide.gifdecoder.GifHeader r6 = r7.header     // Catch:{ all -> 0x00bd }
            java.util.List<com.bumptech.glide.gifdecoder.GifFrame> r6 = r6.frames     // Catch:{ all -> 0x00bd }
            java.lang.Object r5 = r6.get(r5)     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.gifdecoder.GifFrame r5 = (com.bumptech.glide.gifdecoder.GifFrame) r5     // Catch:{ all -> 0x00bd }
            goto L_0x0063
        L_0x0062:
            r5 = r3
        L_0x0063:
            int[] r6 = r4.lct     // Catch:{ all -> 0x00bd }
            if (r6 == 0) goto L_0x006a
            int[] r6 = r4.lct     // Catch:{ all -> 0x00bd }
            goto L_0x006e
        L_0x006a:
            com.bumptech.glide.gifdecoder.GifHeader r6 = r7.header     // Catch:{ all -> 0x00bd }
            int[] r6 = r6.gct     // Catch:{ all -> 0x00bd }
        L_0x006e:
            r7.act = r6     // Catch:{ all -> 0x00bd }
            if (r6 != 0) goto L_0x0083
            java.lang.String r0 = TAG     // Catch:{ all -> 0x00bd }
            boolean r1 = android.util.Log.isLoggable(r0, r1)     // Catch:{ all -> 0x00bd }
            if (r1 == 0) goto L_0x007f
            java.lang.String r1 = "No Valid Color Table"
            android.util.Log.d(r0, r1)     // Catch:{ all -> 0x00bd }
        L_0x007f:
            r7.status = r2     // Catch:{ all -> 0x00bd }
            monitor-exit(r7)
            return r3
        L_0x0083:
            boolean r1 = r4.transparency     // Catch:{ all -> 0x00bd }
            if (r1 == 0) goto L_0x0097
            int[] r1 = r7.act     // Catch:{ all -> 0x00bd }
            int[] r2 = r7.pct     // Catch:{ all -> 0x00bd }
            int r3 = r1.length     // Catch:{ all -> 0x00bd }
            java.lang.System.arraycopy(r1, r0, r2, r0, r3)     // Catch:{ all -> 0x00bd }
            int[] r1 = r7.pct     // Catch:{ all -> 0x00bd }
            r7.act = r1     // Catch:{ all -> 0x00bd }
            int r2 = r4.transIndex     // Catch:{ all -> 0x00bd }
            r1[r2] = r0     // Catch:{ all -> 0x00bd }
        L_0x0097:
            android.graphics.Bitmap r0 = r7.setPixels(r4, r5)     // Catch:{ all -> 0x00bd }
            monitor-exit(r7)
            return r0
        L_0x009d:
            java.lang.String r0 = TAG     // Catch:{ all -> 0x00bd }
            ...
            int r2 = r7.status     // Catch:{ all -> 0x00bd }
            r1.append(r2)     // Catch:{ all -> 0x00bd }
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=short, code=int, for r2v22, types: [short] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x0138 A[LOOP:4: B:58:0x0136->B:59:0x0138, LOOP_END] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
