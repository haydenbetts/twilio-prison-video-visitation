...
class EngineKey implements Key {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            int i4 = 0;
            int hashCode4 = i3 + (resourceDecoder != null ? resourceDecoder.getId().hashCode() : 0);
            this.hashCode = hashCode4;
            int i5 = hashCode4 * 31;
            ResourceDecoder resourceDecoder2 = this.decoder;
            int hashCode5 = i5 + (resourceDecoder2 != null ? resourceDecoder2.getId().hashCode() : 0);
            this.hashCode = hashCode5;
            int i6 = hashCode5 * 31;
            Transformation transformation2 = this.transformation;
            int hashCode6 = i6 + (transformation2 != null ? transformation2.getId().hashCode() : 0);
            this.hashCode = hashCode6;
            int i7 = hashCode6 * 31;
            ResourceEncoder resourceEncoder = this.encoder;
            int hashCode7 = i7 + (resourceEncoder != null ? resourceEncoder.getId().hashCode() : 0);
            this.hashCode = hashCode7;
            int i8 = hashCode7 * 31;
            ResourceTranscoder resourceTranscoder = this.transcoder;
            int hashCode8 = i8 + (resourceTranscoder != null ? resourceTranscoder.getId().hashCode() : 0);
            this.hashCode = hashCode8;
            int i9 = hashCode8 * 31;
            Encoder encoder2 = this.sourceEncoder;
            if (encoder2 != null) {
                i4 = encoder2.getId().hashCode();
            }
            this.hashCode = i9 + i4;
        }
