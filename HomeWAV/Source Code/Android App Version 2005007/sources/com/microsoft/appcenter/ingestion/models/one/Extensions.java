...
public class Extensions implements Model {
    ...
    public boolean equals(Object obj) {
        ...
        NetExtension netExtension = this.f4net;
        if (netExtension == null ? extensions.f4net != null : !netExtension.equals(extensions.f4net)) {
            return false;
        }
