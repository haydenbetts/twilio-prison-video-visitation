...
public class CryptoUtils {
    ...
    CryptoUtils(android.content.Context r3, com.microsoft.appcenter.utils.crypto.CryptoUtils.ICryptoFactory r4, int r5) {
        ...
        L_0x0028:
            ...
            com.microsoft.appcenter.utils.crypto.CryptoAesHandler r3 = new com.microsoft.appcenter.utils.crypto.CryptoAesHandler     // Catch:{ Exception -> 0x0039 }
            r3.<init>()     // Catch:{ Exception -> 0x0039 }
            r2.registerHandler(r3)     // Catch:{ Exception -> 0x0039 }
            goto L_0x003e
        L_0x0039:
        ...
        L_0x003e:
            ...
            com.microsoft.appcenter.utils.crypto.CryptoRsaHandler r3 = new com.microsoft.appcenter.utils.crypto.CryptoRsaHandler     // Catch:{ Exception -> 0x0049 }
            r3.<init>()     // Catch:{ Exception -> 0x0049 }
            r2.registerHandler(r3)     // Catch:{ Exception -> 0x0049 }
            goto L_0x004e
        L_0x0049:
