...
final class AirshipAnalytics$onMoney$2<T> implements Consumer<Throwable> {
    final /* synthetic */ String $userId;
    final /* synthetic */ AirshipAnalytics this$0;

    AirshipAnalytics$onMoney$2(AirshipAnalytics airshipAnalytics, String str) {
    ...
    public final void accept(Throwable th) {
        Observable create = Observable.create(new ObservableOnSubscribe<T>(this) {
            final /* synthetic */ AirshipAnalytics$onMoney$2 this$0;
