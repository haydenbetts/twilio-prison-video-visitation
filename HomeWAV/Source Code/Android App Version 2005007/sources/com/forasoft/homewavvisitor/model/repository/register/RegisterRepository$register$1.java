...
final class RegisterRepository$register$1<T> implements Consumer<ApiResponse<? extends User>> {
    final /* synthetic */ RegisterRepository this$0;

    RegisterRepository$register$1(RegisterRepository registerRepository) {
    ...
    public final void accept(ApiResponse<User> apiResponse) {
        ...
        if (body != null) {
            this.this$0.userDao.saveUser(body);
        }
    }
}
