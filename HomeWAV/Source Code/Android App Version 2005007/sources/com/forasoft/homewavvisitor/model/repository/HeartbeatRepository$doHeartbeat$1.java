...
final class HeartbeatRepository$doHeartbeat$1<T> implements Predicate<Response<? extends State>> {
    public static final HeartbeatRepository$doHeartbeat$1 INSTANCE = new HeartbeatRepository$doHeartbeat$1();

    HeartbeatRepository$doHeartbeat$1() {
    }
