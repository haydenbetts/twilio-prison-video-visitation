...
final class HeartbeatService$onStartCommand$2<T, R> implements Function<T, R> {
    public static final HeartbeatService$onStartCommand$2 INSTANCE = new HeartbeatService$onStartCommand$2();

    HeartbeatService$onStartCommand$2() {
    }
