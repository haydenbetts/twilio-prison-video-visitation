...
final class S3MediaLoader$getVideos$1<T, R> implements Function<T, SingleSource<? extends R>> {
    public static final S3MediaLoader$getVideos$1 INSTANCE = new S3MediaLoader$getVideos$1();

    S3MediaLoader$getVideos$1() {
    }
