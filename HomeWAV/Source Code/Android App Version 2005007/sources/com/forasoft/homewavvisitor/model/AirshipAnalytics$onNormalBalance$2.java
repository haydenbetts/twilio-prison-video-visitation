...
final class AirshipAnalytics$onNormalBalance$2<T> implements Consumer<Throwable> {
    final /* synthetic */ String $userId;
    final /* synthetic */ AirshipAnalytics this$0;

    AirshipAnalytics$onNormalBalance$2(AirshipAnalytics airshipAnalytics, String str) {
    ...
    public final void accept(Throwable th) {
        Observable create = Observable.create(new ObservableOnSubscribe<T>(this) {
            final /* synthetic */ AirshipAnalytics$onNormalBalance$2 this$0;
