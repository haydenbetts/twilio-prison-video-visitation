...
final class RegisterRepository$editProfile$2<T> implements Consumer<ApiResponse<? extends User>> {
    final /* synthetic */ RegisterRepository this$0;

    RegisterRepository$editProfile$2(RegisterRepository registerRepository) {
    ...
    public final void accept(ApiResponse<User> apiResponse) {
        ...
        if (body != null) {
            UserDao access$getUserDao$p = this.this$0.userDao;
            Intrinsics.checkExpressionValueIsNotNull(body, "it");
            access$getUserDao$p.saveUser(body);
        }
    }
}
