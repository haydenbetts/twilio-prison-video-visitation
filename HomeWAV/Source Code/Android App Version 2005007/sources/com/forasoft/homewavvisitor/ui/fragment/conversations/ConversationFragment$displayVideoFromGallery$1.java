...
final class ConversationFragment$displayVideoFromGallery$1<T> implements StreamModelLoader<String> {
    public static final ConversationFragment$displayVideoFromGallery$1 INSTANCE = new ConversationFragment$displayVideoFromGallery$1();

    ConversationFragment$displayVideoFromGallery$1() {
    }
