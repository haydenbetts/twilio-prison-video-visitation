...
final class ChooseFundsFragment$onResume$4 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ ChooseFundsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChooseFundsFragment$onResume$4(ChooseFundsFragment chooseFundsFragment) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        int access$getSelectedAmount = this.this$0.getSelectedAmount();
        ...
        presenter.navigateToPaynearme(access$getSelectedAmount, editText.getText().toString());
    }
}
