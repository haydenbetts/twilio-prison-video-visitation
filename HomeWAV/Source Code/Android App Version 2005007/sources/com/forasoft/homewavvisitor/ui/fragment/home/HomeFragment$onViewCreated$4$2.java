...
final /* synthetic */ class HomeFragment$onViewCreated$4$2 extends FunctionReference implements Function1<Inmate, Unit> {
    HomeFragment$onViewCreated$4$2(HomePresenter homePresenter) {
    ...
    public final void invoke(Inmate inmate) {
        ...
        ((HomePresenter) this.receiver).onInmateClicked(inmate);
    }
}
