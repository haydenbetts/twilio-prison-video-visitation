...
final /* synthetic */ class PendingInmatesFragment$setupList$1$2 extends FunctionReference implements Function1<Inmate, Unit> {
    PendingInmatesFragment$setupList$1$2(PendingInmatesPresenter pendingInmatesPresenter) {
    ...
    public final String getSignature() {
        return "onAddFundsClicked(Lcom/forasoft/homewavvisitor/model/data/Inmate;)V";
    }
    ...
    public final void invoke(Inmate inmate) {
        ...
        ((PendingInmatesPresenter) this.receiver).onAddFundsClicked(inmate);
    }
}
