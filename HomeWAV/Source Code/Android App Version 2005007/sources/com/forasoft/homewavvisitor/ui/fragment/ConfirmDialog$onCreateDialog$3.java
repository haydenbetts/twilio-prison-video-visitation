...
final class ConfirmDialog$onCreateDialog$3 implements DialogInterface.OnClickListener {
    final /* synthetic */ ConfirmDialog this$0;

    ConfirmDialog$onCreateDialog$3(ConfirmDialog confirmDialog) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (access$getConfirmDialogListener$p != null) {
            access$getConfirmDialogListener$p.onCanceled();
        }
    }
}
