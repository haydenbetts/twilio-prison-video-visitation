...
public final class AccountTabFragment extends BaseTabFragment implements CallListener {
    ...
    public void setRootFragment() {
        getRouter().newRootScreen(Screens.AccountScreen.INSTANCE);
    }

    /* access modifiers changed from: protected */
    public String getScreenKey() {
        String screenKey = Screens.AccountTabScreen.INSTANCE.getScreenKey();
        Intrinsics.checkExpressionValueIsNotNull(screenKey, "Screens.AccountTabScreen.screenKey");
        return screenKey;
    }
