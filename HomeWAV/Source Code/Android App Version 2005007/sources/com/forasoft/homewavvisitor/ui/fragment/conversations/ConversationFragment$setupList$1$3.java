...
final /* synthetic */ class ConversationFragment$setupList$1$3 extends FunctionReference implements Function1<Message, Unit> {
    ConversationFragment$setupList$1$3(ConversationPresenter conversationPresenter) {
        super(1, conversationPresenter);
    }

    public final String getName() {
        return "onImagePreviewClicked";
    }
    ...
    public final String getSignature() {
        return "onImagePreviewClicked(Lcom/forasoft/homewavvisitor/model/data/Message;)V";
    }
    ...
    public final void invoke(Message message) {
        ...
        ((ConversationPresenter) this.receiver).onImagePreviewClicked(message);
    }
}
