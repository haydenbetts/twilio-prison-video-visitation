...
final class ForgotPasswordFragment$onResume$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ ForgotPasswordFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ForgotPasswordFragment$onResume$2(ForgotPasswordFragment forgotPasswordFragment) {
        super(1);
    ...
    public final void invoke(View view) {
        ForgotPasswordPresenter presenter = this.this$0.getPresenter();
        ...
        presenter.onSubmitClicked(editText.getText());
    }
}
