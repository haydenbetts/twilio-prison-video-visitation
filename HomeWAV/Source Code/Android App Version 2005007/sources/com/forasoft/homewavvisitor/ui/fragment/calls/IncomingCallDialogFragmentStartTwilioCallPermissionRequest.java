...
final class IncomingCallDialogFragmentStartTwilioCallPermissionRequest implements GrantableRequest {
    ...
    public void proceed() {
        ...
        if (incomingCallDialogFragment != null) {
            ...
            incomingCallDialogFragment.requestPermissions(IncomingCallDialogFragmentPermissionsDispatcher.PERMISSION_STARTTWILIOCALL, IncomingCallDialogFragmentPermissionsDispatcher.REQUEST_STARTTWILIOCALL);
        }
    }
    ...
    public void grant() {
        ...
        if (incomingCallDialogFragment != null) {
            Intrinsics.checkExpressionValueIsNotNull(incomingCallDialogFragment, "weakTarget.get() ?: return");
            incomingCallDialogFragment.startTwilioCall(this.callId, this.pubid);
        }
    }
}
