...
final class SignUp1Fragment$onResume$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ SignUp1Fragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SignUp1Fragment$onResume$1(SignUp1Fragment signUp1Fragment) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        factory.show(requireContext).setResultReceiver(new Function1<String, Unit>(this) {
            final /* synthetic */ SignUp1Fragment$onResume$1 this$0;
            ...
            public final void invoke(String str) {
                ...
                if (Intrinsics.areEqual((Object) str, (Object) AvatarUpdaterDialog.CAMERA)) {
                    SignUp1FragmentPermissionsDispatcher.onAvatarFromCameraWithPermissionCheck(this.this$0.this$0);
                    this.this$0.this$0.setAvatarRequested(true);
                    return;
                }
                this.this$0.this$0.getPresenter().onProfileImageClicked(AvatarUpdaterDialog.GALLERY);
            }
        });
    }
}
