...
final class AddInmateView$initAddInmateViews$1 extends Lambda implements Function1<__TextWatcher, Unit> {
    final /* synthetic */ AddInmateView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AddInmateView$initAddInmateViews$1(AddInmateView addInmateView) {
        super(1);
    ...
    public final void invoke(__TextWatcher __textwatcher) {
        ...
        __textwatcher.afterTextChanged((Function1<? super Editable, Unit>) new Function1<Editable, Unit>(this) {
            final /* synthetic */ AddInmateView$initAddInmateViews$1 this$0;
            ...
            public final void invoke(Editable editable) {
                this.this$0.this$0.getConnection().setFirstName(String.valueOf(editable));
