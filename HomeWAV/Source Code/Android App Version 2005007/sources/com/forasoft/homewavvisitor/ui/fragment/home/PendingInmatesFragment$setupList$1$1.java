...
final /* synthetic */ class PendingInmatesFragment$setupList$1$1 extends FunctionReference implements Function1<Inmate, Unit> {
    PendingInmatesFragment$setupList$1$1(PendingInmatesPresenter pendingInmatesPresenter) {
    ...
    public final void invoke(Inmate inmate) {
        ...
        ((PendingInmatesPresenter) this.receiver).onInmateClicked(inmate);
    }
}
