...
final class AddInmateView$initExplanation$1 extends Lambda implements Function1<__TextWatcher, Unit> {
    final /* synthetic */ AddInmateView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AddInmateView$initExplanation$1(AddInmateView addInmateView) {
        super(1);
    ...
    public final void invoke(__TextWatcher __textwatcher) {
        ...
        __textwatcher.afterTextChanged((Function1<? super Editable, Unit>) new Function1<Editable, Unit>(this) {
            final /* synthetic */ AddInmateView$initExplanation$1 this$0;
            ...
            public final void invoke(Editable editable) {
                this.this$0.this$0.getConnection().setRelationshipExplanation(String.valueOf(editable));
