...
final class MainPresenter$acceptTerms$1<T> implements Consumer<ApiResponse<? extends Object>> {
    public static final MainPresenter$acceptTerms$1 INSTANCE = new MainPresenter$acceptTerms$1();

    MainPresenter$acceptTerms$1() {
    }
