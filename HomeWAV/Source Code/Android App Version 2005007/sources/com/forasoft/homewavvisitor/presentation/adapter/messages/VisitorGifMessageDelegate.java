...
public final class VisitorGifMessageDelegate extends AbsListItemAdapterDelegate<Message, ChatItem, VisitorGifMessageVH> {
    ...
    public VisitorGifMessageVH onCreateViewHolder(ViewGroup viewGroup) {
        Intrinsics.checkParameterIsNotNull(viewGroup, "parent");
        return new VisitorGifMessageVH(ContextExtensionsKt.inflate$default(viewGroup, R.layout.item_visitor_gif_message, false, 2, (Object) null), this.user, this.onClickListener);
    }

    /* access modifiers changed from: protected */
    public void onBindViewHolder(Message message, VisitorGifMessageVH visitorGifMessageVH, List<Object> list) {
        Intrinsics.checkParameterIsNotNull(message, "item");
        Intrinsics.checkParameterIsNotNull(visitorGifMessageVH, "holder");
        Intrinsics.checkParameterIsNotNull(list, "payloads");
        visitorGifMessageVH.bind(message);
    }
