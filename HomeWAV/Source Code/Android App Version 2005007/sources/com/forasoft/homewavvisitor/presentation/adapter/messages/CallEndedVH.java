...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u000e\u0010\u0004\u001a\u00020\u0005X\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Lcom/forasoft/homewavvisitor/presentation/adapter/messages/CallEndedVH;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "itemView", "Landroid/view/View;", "user", "Lcom/forasoft/homewavvisitor/model/data/auth/User;", "(Landroid/view/View;Lcom/forasoft/homewavvisitor/model/data/auth/User;)V", "bind", "", "item", "Lcom/forasoft/homewavvisitor/model/data/CallEndedEvent;", "app_release"}, k = 1, mv = {1, 1, 16})
/* compiled from: CallEndedVH.kt */
public final class CallEndedVH extends RecyclerView.ViewHolder {
    private final User user;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CallEndedVH(View view, User user2) {
        super(view);
    ...
    public final void bind(CallEndedEvent callEndedEvent) {
        Intrinsics.checkParameterIsNotNull(callEndedEvent, "item");
        CallEntity call = callEndedEvent.getCall();
        ...
        textView.setText(view.getResources().getString(air.HomeWAV.R.string.call_ended, new Object[]{call.getInmate_name()}));
        TextView textView2 = (TextView) view.findViewById(R.id.tv_date);
        Intrinsics.checkExpressionValueIsNotNull(textView2, "tv_date");
        LocalDateTime disconnected = call.getDisconnected();
        textView2.setText(disconnected != null ? DateExtensionsKt.getAsShortTime(disconnected) : null);
    }
}
