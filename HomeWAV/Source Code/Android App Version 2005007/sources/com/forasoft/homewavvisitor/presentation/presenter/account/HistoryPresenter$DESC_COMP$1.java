...
final class HistoryPresenter$DESC_COMP$1<T> implements Comparator<HistoryItem> {
    public static final HistoryPresenter$DESC_COMP$1 INSTANCE = new HistoryPresenter$DESC_COMP$1();

    HistoryPresenter$DESC_COMP$1() {
    }
