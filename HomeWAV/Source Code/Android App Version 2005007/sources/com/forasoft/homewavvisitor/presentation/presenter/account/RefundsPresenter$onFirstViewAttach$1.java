...
final class RefundsPresenter$onFirstViewAttach$1<T> implements Consumer<List<? extends Inmate>> {
    final /* synthetic */ RefundsPresenter this$0;

    RefundsPresenter$onFirstViewAttach$1(RefundsPresenter refundsPresenter) {
        this.this$0 = refundsPresenter;
    }

    public final void accept(List<Inmate> list) {
        RefundsPresenter refundsPresenter = this.this$0;
        Intrinsics.checkExpressionValueIsNotNull(list, "it");
        refundsPresenter.inmates = list;
    }
}
