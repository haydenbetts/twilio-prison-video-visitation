...
final class HomePresenter$getVisits$1<T, R> implements Function<T, R> {
    public static final HomePresenter$getVisits$1 INSTANCE = new HomePresenter$getVisits$1();

    HomePresenter$getVisits$1() {
    }
