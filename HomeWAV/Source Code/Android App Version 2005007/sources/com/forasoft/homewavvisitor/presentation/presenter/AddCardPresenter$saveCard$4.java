...
final class AddCardPresenter$saveCard$4<T> implements Consumer<Throwable> {
    final /* synthetic */ AddCardPresenter this$0;

    AddCardPresenter$saveCard$4(AddCardPresenter addCardPresenter) {
        this.this$0 = addCardPresenter;
    }

    public final void accept(Throwable th) {
        ((AddCardView) this.this$0.getViewState()).showProgress(false);
        ((AddCardView) this.this$0.getViewState()).showMessage((int) R.string.card_error);
    }
}
