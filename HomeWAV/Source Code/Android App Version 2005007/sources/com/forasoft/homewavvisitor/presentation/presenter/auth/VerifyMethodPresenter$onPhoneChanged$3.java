...
final class VerifyMethodPresenter$onPhoneChanged$3 implements Action {
    final /* synthetic */ String $newPhone;
    final /* synthetic */ VerifyMethodPresenter this$0;

    VerifyMethodPresenter$onPhoneChanged$3(VerifyMethodPresenter verifyMethodPresenter, String str) {
        this.this$0 = verifyMethodPresenter;
        this.$newPhone = str;
    }

    public final void run() {
        ((VerifyMethodView) this.this$0.getViewState()).showPhone(this.$newPhone);
    }
}
