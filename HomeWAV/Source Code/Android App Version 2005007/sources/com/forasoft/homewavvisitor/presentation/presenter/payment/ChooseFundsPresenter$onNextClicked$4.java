...
final class ChooseFundsPresenter$onNextClicked$4<T> implements Consumer<ApiResponse<? extends PaymentProcessedResponse>> {
    final /* synthetic */ ChooseFundsPresenter this$0;

    ChooseFundsPresenter$onNextClicked$4(ChooseFundsPresenter chooseFundsPresenter) {
    ...
    public final void accept(ApiResponse<PaymentProcessedResponse> apiResponse) {
        if (apiResponse.getOk()) {
            this.this$0.analytics.onAddFunds();
            ((ChooseFundsView) this.this$0.getViewState()).showSuccessMessage();
            ChooseFundsView chooseFundsView = (ChooseFundsView) this.this$0.getViewState();
