...
final class TransferFundsPresenter$onSelectFromClicked$1$onResult$1<T> implements Consumer<List<? extends Facility>> {
    final /* synthetic */ Object $resultData;
    final /* synthetic */ TransferFundsPresenter$onSelectFromClicked$1 this$0;

    TransferFundsPresenter$onSelectFromClicked$1$onResult$1(TransferFundsPresenter$onSelectFromClicked$1 transferFundsPresenter$onSelectFromClicked$1, Object obj) {
        this.this$0 = transferFundsPresenter$onSelectFromClicked$1;
        this.$resultData = obj;
    }
    ...
    public final void accept(List<Facility> list) {
        ...
        if (obj2 != null) {
            ...
            if (Intrinsics.areEqual((Object) str, (Object) "0")) {
                this.this$0.this$0.inmateFrom = inmate;
                ((TransferFundsView) this.this$0.this$0.getViewState()).showFromInmate(inmate);
            } else {
