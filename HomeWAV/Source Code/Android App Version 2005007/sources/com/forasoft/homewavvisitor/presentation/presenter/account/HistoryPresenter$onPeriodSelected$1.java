...
final class HistoryPresenter$onPeriodSelected$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$onPeriodSelected$1 INSTANCE = new HistoryPresenter$onPeriodSelected$1();

    HistoryPresenter$onPeriodSelected$1() {
        super(1);
    }
