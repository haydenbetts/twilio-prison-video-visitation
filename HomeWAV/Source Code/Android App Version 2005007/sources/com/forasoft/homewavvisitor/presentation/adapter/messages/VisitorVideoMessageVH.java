...
/* compiled from: VisitorVideoMessageVH.kt */
public final class VisitorVideoMessageVH extends RecyclerView.ViewHolder {
    /* access modifiers changed from: private */
    public final Function1<Message, Unit> onClickListener;
    private final User user;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VisitorVideoMessageVH(View view, User user2, Function1<? super Message, Unit> function1) {
        super(view);
    ...
    public final void bind(Message message) {
        ...
        StreamModelLoader streamModelLoader = VisitorVideoMessageVH$bind$1$modelLoader$1.INSTANCE;
        if (message.getVideoUrl() == null) {
            Glide.with(view.getContext()).using(streamModelLoader).load(message.getStreamUrl()).into((ImageView) view.findViewById(R.id.iv_preview));
        } else {
            Glide.with(view.getContext()).using(streamModelLoader).load(message.getVideoUrl()).into((ImageView) view.findViewById(R.id.iv_preview));
        }
        ((ImageView) view.findViewById(R.id.iv_preview)).setOnClickListener(new VisitorVideoMessageVH$bind$$inlined$with$lambda$1(this, message));
