...
final class PendingInmatesPresenter$onAddFundsClicked$4<T> implements Consumer<ApiResponse<? extends List<? extends Facility>>> {
    final /* synthetic */ PendingInmatesPresenter this$0;

    PendingInmatesPresenter$onAddFundsClicked$4(PendingInmatesPresenter pendingInmatesPresenter) {
    ...
    public final void accept(com.forasoft.homewavvisitor.model.server.response.ApiResponse<? extends java.util.List<com.forasoft.homewavvisitor.model.data.Facility>> r5) {
        ...
        L_0x0015:
            ...
            com.forasoft.homewavvisitor.presentation.presenter.home.PendingInmatesPresenter r3 = r4.this$0
        ...
        L_0x003e:
            com.forasoft.homewavvisitor.presentation.presenter.home.PendingInmatesPresenter r5 = r4.this$0
            ...
            com.forasoft.homewavvisitor.presentation.presenter.home.PendingInmatesPresenter r0 = r4.this$0
        ...
        L_0x006c:
            ...
            com.forasoft.homewavvisitor.presentation.view.home.PendingInmatesView r5 = (com.forasoft.homewavvisitor.presentation.view.home.PendingInmatesView) r5
            r0 = 2131821022(0x7f1101de, float:1.9274775E38)
            r5.showMessage((int) r0)
        L_0x007a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.forasoft.homewavvisitor.presentation.presenter.home.PendingInmatesPresenter$onAddFundsClicked$4.accept(com.forasoft.homewavvisitor.model.server.response.ApiResponse):void");
    }
}
