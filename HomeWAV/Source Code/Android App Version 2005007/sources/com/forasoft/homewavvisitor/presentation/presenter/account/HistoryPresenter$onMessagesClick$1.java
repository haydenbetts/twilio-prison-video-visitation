...
final class HistoryPresenter$onMessagesClick$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$onMessagesClick$1 INSTANCE = new HistoryPresenter$onMessagesClick$1();

    HistoryPresenter$onMessagesClick$1() {
        super(1);
    }
    ...
    public final boolean invoke(HistoryItem historyItem) {
        ...
        return historyItem.getItemType() == HistoryItem.Type.MESSAGE;
    }
}
