...
final class InmateDetailPresenter$onDeleteSuccess$3<T> implements Consumer<Throwable> {
    final /* synthetic */ InmateDetailPresenter this$0;

    InmateDetailPresenter$onDeleteSuccess$3(InmateDetailPresenter inmateDetailPresenter) {
        this.this$0 = inmateDetailPresenter;
    }

    public final void accept(Throwable th) {
        ((InmateDetailView) this.this$0.getViewState()).showMessage("Delete failed");
    }
}
