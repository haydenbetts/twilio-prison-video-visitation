...
final class TwilioCallPresenter$startCheckIn$1<T> implements Predicate<Long> {
    final /* synthetic */ TwilioCallPresenter this$0;

    TwilioCallPresenter$startCheckIn$1(TwilioCallPresenter twilioCallPresenter) {
        this.this$0 = twilioCallPresenter;
    }

    public final boolean test(Long l) {
        Intrinsics.checkParameterIsNotNull(l, "it");
        return !this.this$0.isDisconnectRequested;
    }
}
