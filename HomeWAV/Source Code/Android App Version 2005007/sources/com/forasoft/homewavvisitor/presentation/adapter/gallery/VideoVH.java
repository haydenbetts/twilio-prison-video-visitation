...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0010\u0000\n\u0000\u0018\u00002\u00020\u0001B!\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005¢\u0006\u0002\u0010\bJ$\u0010\t\u001a\u00020\u00072\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u00062\f\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000f0\u000eR\u001a\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lcom/forasoft/homewavvisitor/presentation/adapter/gallery/VideoVH;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "itemView", "Landroid/view/View;", "onItemSelectedListener", "Lkotlin/Function1;", "", "", "(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V", "bind", "video", "Lcom/forasoft/homewavvisitor/model/Video;", "selectedItemPosition", "payload", "", "", "app_release"}, k = 1, mv = {1, 1, 16})
...
public final class VideoVH extends RecyclerView.ViewHolder {
    ...
    public VideoVH(View view, Function1<? super Integer, Unit> function1) {
        super(view);
    ...
    public final void bind(Video video, int i, List<Object> list) {
        ...
        if (list.isEmpty()) {
            ...
            if (CollectionsKt.contains(SetsKt.setOf("http", "https"), parse.getScheme())) {
                Glide.with(view.getContext()).using(VideoVH$bind$1$1.INSTANCE).load(video.getUri()).into((ImageView) view.findViewById(R.id.imageView));
            } else {
                Glide.with(view.getContext()).load(video.getUri()).into((ImageView) view.findViewById(R.id.imageView));
            }
        } else {
        ...
        view.setOnClickListener(new VideoVH$inlined$sam$i$android_view_View_OnClickListener$0(new VideoVH$bind$$inlined$with$lambda$1(this, list, i, video)));
    }
}
