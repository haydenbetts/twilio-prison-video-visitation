...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u00012!\u0010\u0002\u001a\u001d\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\u00040\u0003¢\u0006\f\b\u0006\u0012\b\b\u0007\u0012\u0004\b\b(\b¢\u0006\u0002\b\t"}, d2 = {"<anonymous>", "", "p1", "Lcom/forasoft/homewavvisitor/model/server/response/Response;", "", "Lcom/forasoft/homewavvisitor/model/data/Inmate;", "Lkotlin/ParameterName;", "name", "response", "invoke"}, k = 3, mv = {1, 1, 16})
/* compiled from: HomePresenter.kt */
final /* synthetic */ class HomePresenter$getInmates$1$1 extends FunctionReference implements Function1<Response<? extends List<? extends Inmate>>, Unit> {
    HomePresenter$getInmates$1$1(HomePresenter homePresenter) {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        invoke((Response<? extends List<Inmate>>) (Response) obj);
        return Unit.INSTANCE;
    }

    public final void invoke(Response<? extends List<Inmate>> response) {
        Intrinsics.checkParameterIsNotNull(response, "p1");
        HomePresenter homePresenter = (HomePresenter) this.receiver;
        if (response.getOk()) {
            Class<Inmate> cls = Inmate.class;
