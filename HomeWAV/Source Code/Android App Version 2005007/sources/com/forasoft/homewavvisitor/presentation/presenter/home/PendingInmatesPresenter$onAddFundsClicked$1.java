...
final class PendingInmatesPresenter$onAddFundsClicked$1<T> implements Consumer<Disposable> {
    final /* synthetic */ PendingInmatesPresenter this$0;

    PendingInmatesPresenter$onAddFundsClicked$1(PendingInmatesPresenter pendingInmatesPresenter) {
        this.this$0 = pendingInmatesPresenter;
    }

    public final void accept(Disposable disposable) {
        ((PendingInmatesView) this.this$0.getViewState()).showProgress(true);
    }
}
