...
final class PaymentMethodsPresenter$onFirstViewAttach$1<T> implements Consumer<List<? extends Card>> {
    final /* synthetic */ PaymentMethodsPresenter this$0;

    PaymentMethodsPresenter$onFirstViewAttach$1(PaymentMethodsPresenter paymentMethodsPresenter) {
        this.this$0 = paymentMethodsPresenter;
    }

    public final void accept(List<Card> list) {
        Intrinsics.checkExpressionValueIsNotNull(list, "it");
        ((PaymentMethodsView) this.this$0.getViewState()).displayCards(list);
    }
}
