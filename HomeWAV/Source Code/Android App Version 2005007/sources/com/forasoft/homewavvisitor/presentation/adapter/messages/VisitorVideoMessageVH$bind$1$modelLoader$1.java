...
final class VisitorVideoMessageVH$bind$1$modelLoader$1<T> implements StreamModelLoader<String> {
    public static final VisitorVideoMessageVH$bind$1$modelLoader$1 INSTANCE = new VisitorVideoMessageVH$bind$1$modelLoader$1();

    VisitorVideoMessageVH$bind$1$modelLoader$1() {
    }
