...
final class HistoryPresenter$filterHistory$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$filterHistory$1 INSTANCE = new HistoryPresenter$filterHistory$1();

    HistoryPresenter$filterHistory$1() {
        super(1);
    }
