...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001B)\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0012\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u0007¢\u0006\u0002\u0010\nJ\u000e\u0010\u000b\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\bR\u001a\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u0007X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, d2 = {"Lcom/forasoft/homewavvisitor/presentation/adapter/messages/VisitorImageMessageVH;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "itemView", "Landroid/view/View;", "user", "Lcom/forasoft/homewavvisitor/model/data/auth/User;", "onClickListener", "Lkotlin/Function1;", "Lcom/forasoft/homewavvisitor/model/data/Message;", "", "(Landroid/view/View;Lcom/forasoft/homewavvisitor/model/data/auth/User;Lkotlin/jvm/functions/Function1;)V", "bind", "message", "app_release"}, k = 1, mv = {1, 1, 16})
/* compiled from: VisitorImageMessageVH.kt */
public final class VisitorImageMessageVH extends RecyclerView.ViewHolder {
    /* access modifiers changed from: private */
    public final Function1<Message, Unit> onClickListener;
    private final User user;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VisitorImageMessageVH(View view, User user2, Function1<? super Message, Unit> function1) {
        super(view);
    ...
    public final void bind(Message message) {
        ...
        Glide.with(view.getContext()).load(message.getImageUrl()).into((ImageView) view.findViewById(R.id.iv_preview));
        ...
        ((ImageView) view.findViewById(R.id.iv_preview)).setOnClickListener(new VisitorImageMessageVH$bind$$inlined$with$lambda$1(this, message));
