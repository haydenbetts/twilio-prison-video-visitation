...
final class SignUp4Presenter$subscribe$1<T> implements Predicate<List<? extends Inmate>> {
    public static final SignUp4Presenter$subscribe$1 INSTANCE = new SignUp4Presenter$subscribe$1();

    SignUp4Presenter$subscribe$1() {
    }
