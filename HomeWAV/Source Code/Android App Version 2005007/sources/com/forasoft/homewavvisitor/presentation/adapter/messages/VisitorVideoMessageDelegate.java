...
public final class VisitorVideoMessageDelegate extends AbsListItemAdapterDelegate<Message, ChatItem, VisitorVideoMessageVH> {
    ...
    public VisitorVideoMessageVH onCreateViewHolder(ViewGroup viewGroup) {
        Intrinsics.checkParameterIsNotNull(viewGroup, "parent");
        return new VisitorVideoMessageVH(ContextExtensionsKt.inflate$default(viewGroup, R.layout.item_visitor_video_message, false, 2, (Object) null), this.user, this.onClickListener);
    }

    /* access modifiers changed from: protected */
    public void onBindViewHolder(Message message, VisitorVideoMessageVH visitorVideoMessageVH, List<Object> list) {
        Intrinsics.checkParameterIsNotNull(message, "item");
        Intrinsics.checkParameterIsNotNull(visitorVideoMessageVH, "holder");
        Intrinsics.checkParameterIsNotNull(list, "payloads");
        visitorVideoMessageVH.bind(message);
    }
