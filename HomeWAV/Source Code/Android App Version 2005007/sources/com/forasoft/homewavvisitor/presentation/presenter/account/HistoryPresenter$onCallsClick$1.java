...
final class HistoryPresenter$onCallsClick$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$onCallsClick$1 INSTANCE = new HistoryPresenter$onCallsClick$1();

    HistoryPresenter$onCallsClick$1() {
        super(1);
    }
    ...
    public final boolean invoke(HistoryItem historyItem) {
        ...
        return historyItem.getItemType() == HistoryItem.Type.VIDEO_CALL;
    }
}
