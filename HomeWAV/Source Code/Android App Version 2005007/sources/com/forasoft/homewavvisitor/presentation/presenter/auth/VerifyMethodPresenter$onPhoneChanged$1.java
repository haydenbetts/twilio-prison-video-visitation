...
final class VerifyMethodPresenter$onPhoneChanged$1<T, R> implements Function<ApiResponse<? extends User>, CompletableSource> {
    final /* synthetic */ VerifyMethodPresenter this$0;

    VerifyMethodPresenter$onPhoneChanged$1(VerifyMethodPresenter verifyMethodPresenter) {
    ...
    public final CompletableSource apply(final ApiResponse<User> apiResponse) {
        ...
        if (apiResponse.getOk()) {
            return Completable.fromCallable(new Callable<Object>(this) {
                final /* synthetic */ VerifyMethodPresenter$onPhoneChanged$1 this$0;
