...
final class VerifyCodePresenter$onSubmitClicked$1<T, R> implements Function<T, SingleSource<? extends R>> {
    final /* synthetic */ String $code;
    final /* synthetic */ VerifyCodePresenter this$0;

    VerifyCodePresenter$onSubmitClicked$1(VerifyCodePresenter verifyCodePresenter, String str) {
    ...
    public final Single<ApiResponse<List<Object>>> apply(User user) {
        ...
        return this.this$0.api.verify(user.getId(), this.this$0.channel, this.$code);
    }
}
