...
final class ChooseFundsPresenter$onNextClicked$2<T> implements Consumer<Disposable> {
    final /* synthetic */ ChooseFundsPresenter this$0;

    ChooseFundsPresenter$onNextClicked$2(ChooseFundsPresenter chooseFundsPresenter) {
        this.this$0 = chooseFundsPresenter;
    }

    public final void accept(Disposable disposable) {
        ((ChooseFundsView) this.this$0.getViewState()).showProgress(true);
    }
}
