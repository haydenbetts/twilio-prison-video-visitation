...
final class HistoryPresenter$countItems$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$countItems$1 INSTANCE = new HistoryPresenter$countItems$1();

    HistoryPresenter$countItems$1() {
        super(1);
    }
