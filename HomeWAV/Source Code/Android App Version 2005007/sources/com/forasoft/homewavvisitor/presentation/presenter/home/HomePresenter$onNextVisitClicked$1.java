...
final class HomePresenter$onNextVisitClicked$1<T> implements Consumer<List<? extends ScheduledVisit>> {
    final /* synthetic */ HomePresenter this$0;

    HomePresenter$onNextVisitClicked$1(HomePresenter homePresenter) {
    ...
    public final void accept(List<ScheduledVisit> list) {
        ...
        if (!list.isEmpty()) {
            this.this$0.router.navigateTo(new Screens.VisitDetailsScreen(list.get(0).getSlotId()));
        }
    }
}
