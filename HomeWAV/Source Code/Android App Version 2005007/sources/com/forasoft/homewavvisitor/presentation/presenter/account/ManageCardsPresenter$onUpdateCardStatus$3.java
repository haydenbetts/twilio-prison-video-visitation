...
final class ManageCardsPresenter$onUpdateCardStatus$3<T> implements Consumer<ApiResponse<? extends List<? extends Card>>> {
    final /* synthetic */ ManageCardsPresenter this$0;

    ManageCardsPresenter$onUpdateCardStatus$3(ManageCardsPresenter manageCardsPresenter) {
        this.this$0 = manageCardsPresenter;
    }

    public final void accept(ApiResponse<? extends List<Card>> apiResponse) {
        BehaviorSubject access$getCardsSubject$p = this.this$0.cardsSubject;
        Object body = apiResponse.getBody();
        if (body == null) {
            Intrinsics.throwNpe();
        }
        access$getCardsSubject$p.onNext(body);
    }
}
