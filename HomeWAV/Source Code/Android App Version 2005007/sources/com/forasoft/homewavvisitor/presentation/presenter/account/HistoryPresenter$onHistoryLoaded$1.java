...
final class HistoryPresenter$onHistoryLoaded$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$onHistoryLoaded$1 INSTANCE = new HistoryPresenter$onHistoryLoaded$1();

    HistoryPresenter$onHistoryLoaded$1() {
        super(1);
    }
