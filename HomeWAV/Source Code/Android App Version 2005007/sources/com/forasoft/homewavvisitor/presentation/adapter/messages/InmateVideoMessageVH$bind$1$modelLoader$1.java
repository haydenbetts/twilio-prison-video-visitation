...
final class InmateVideoMessageVH$bind$1$modelLoader$1<T> implements StreamModelLoader<String> {
    public static final InmateVideoMessageVH$bind$1$modelLoader$1 INSTANCE = new InmateVideoMessageVH$bind$1$modelLoader$1();

    InmateVideoMessageVH$bind$1$modelLoader$1() {
    }
