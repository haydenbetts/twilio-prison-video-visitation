...
final class VisitDetailsPresenter$onFirstViewAttach$1<T> implements Consumer<ScheduledVisit> {
    final /* synthetic */ VisitDetailsPresenter this$0;

    VisitDetailsPresenter$onFirstViewAttach$1(VisitDetailsPresenter visitDetailsPresenter) {
        this.this$0 = visitDetailsPresenter;
    }

    public final void accept(ScheduledVisit scheduledVisit) {
        this.this$0.getInmateStatus(scheduledVisit.getInmateId());
        Intrinsics.checkExpressionValueIsNotNull(scheduledVisit, "it");
        ((VisitDetailsView) this.this$0.getViewState()).displayVisit(scheduledVisit);
    }
}
