...
final class HistoryPresenter$onMoneyClick$1 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$onMoneyClick$1 INSTANCE = new HistoryPresenter$onMoneyClick$1();

    HistoryPresenter$onMoneyClick$1() {
        super(1);
    }
    ...
    public final boolean invoke(HistoryItem historyItem) {
        ...
        return historyItem.getItemType() == HistoryItem.Type.MONEY;
    }
}
