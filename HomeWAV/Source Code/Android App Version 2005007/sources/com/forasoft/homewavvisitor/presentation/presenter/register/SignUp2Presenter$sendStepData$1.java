...
final /* synthetic */ class SignUp2Presenter$sendStepData$1 extends FunctionReference implements Function1<ApiResponse<? extends User>, Unit> {
    SignUp2Presenter$sendStepData$1(SignUp2Presenter signUp2Presenter) {
    ...
    public final void invoke(ApiResponse<User> apiResponse) {
        ...
        ((SignUp2Presenter) this.receiver).onRegisterSuccess(apiResponse);
    }
}
