...
final class VerifyCodePresenter$onSubmitClicked$3<T> implements Consumer<Throwable> {
    final /* synthetic */ VerifyCodePresenter this$0;

    VerifyCodePresenter$onSubmitClicked$3(VerifyCodePresenter verifyCodePresenter) {
        this.this$0 = verifyCodePresenter;
    }

    public final void accept(Throwable th) {
        this.this$0.handleError((ErrorCause) null);
    }
}
