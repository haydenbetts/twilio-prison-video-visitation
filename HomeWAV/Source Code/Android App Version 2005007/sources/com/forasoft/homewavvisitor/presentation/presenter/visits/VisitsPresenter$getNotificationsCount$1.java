...
final class VisitsPresenter$getNotificationsCount$1<T> implements Consumer<Integer> {
    final /* synthetic */ VisitsPresenter this$0;

    VisitsPresenter$getNotificationsCount$1(VisitsPresenter visitsPresenter) {
        this.this$0 = visitsPresenter;
    }

    public final void accept(Integer num) {
        Intrinsics.checkExpressionValueIsNotNull(num, "it");
        ((VisitsView) this.this$0.getViewState()).updateNotificationMenu(num.intValue());
    }
}
