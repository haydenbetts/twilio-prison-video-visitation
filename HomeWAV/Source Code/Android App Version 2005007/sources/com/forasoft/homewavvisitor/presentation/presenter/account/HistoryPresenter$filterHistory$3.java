...
final class HistoryPresenter$filterHistory$3 extends Lambda implements Function1<HistoryItem, Boolean> {
    public static final HistoryPresenter$filterHistory$3 INSTANCE = new HistoryPresenter$filterHistory$3();

    HistoryPresenter$filterHistory$3() {
        super(1);
    }
