...
final class VisitsPresenter$onFirstViewAttach$1<T> implements Consumer<List<? extends ScheduledVisit>> {
    final /* synthetic */ VisitsPresenter this$0;

    VisitsPresenter$onFirstViewAttach$1(VisitsPresenter visitsPresenter) {
        this.this$0 = visitsPresenter;
    }

    public final void accept(List<ScheduledVisit> list) {
        Intrinsics.checkExpressionValueIsNotNull(list, "it");
        ((VisitsView) this.this$0.getViewState()).displayScheduledVisits(list);
    }
}
