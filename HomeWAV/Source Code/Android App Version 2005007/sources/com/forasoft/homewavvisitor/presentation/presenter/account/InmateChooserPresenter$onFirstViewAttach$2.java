...
final class InmateChooserPresenter$onFirstViewAttach$2<T> implements Consumer<List<? extends Inmate>> {
    final /* synthetic */ InmateChooserPresenter this$0;

    InmateChooserPresenter$onFirstViewAttach$2(InmateChooserPresenter inmateChooserPresenter) {
    ...
    public final void accept(final List<Inmate> list) {
        ...
        Disposable subscribe = this.this$0.heartbeatRepository.getHeartbeatState().subscribe(new Consumer<State>(this) {
            final /* synthetic */ InmateChooserPresenter$onFirstViewAttach$2 this$0;
