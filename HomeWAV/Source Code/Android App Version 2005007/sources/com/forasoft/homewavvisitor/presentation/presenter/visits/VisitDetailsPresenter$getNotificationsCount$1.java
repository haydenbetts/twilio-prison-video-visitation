...
final class VisitDetailsPresenter$getNotificationsCount$1<T> implements Consumer<Integer> {
    final /* synthetic */ VisitDetailsPresenter this$0;

    VisitDetailsPresenter$getNotificationsCount$1(VisitDetailsPresenter visitDetailsPresenter) {
        this.this$0 = visitDetailsPresenter;
    }

    public final void accept(Integer num) {
        Intrinsics.checkExpressionValueIsNotNull(num, "it");
        ((VisitDetailsView) this.this$0.getViewState()).updateNotificationMenu(num.intValue());
    }
}
