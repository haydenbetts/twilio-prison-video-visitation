...
final /* synthetic */ class EditPhotosPresenter$saveStepData$1 extends FunctionReference implements Function1<ApiResponse<? extends User>, Unit> {
    EditPhotosPresenter$saveStepData$1(EditPhotosPresenter editPhotosPresenter) {
        super(1, editPhotosPresenter);
    }

    public final String getName() {
        return "onProfileEditSuccess";
    }
    ...
    public final String getSignature() {
        return "onProfileEditSuccess(Lcom/forasoft/homewavvisitor/model/server/response/ApiResponse;)V";
    }
    ...
    public final void invoke(ApiResponse<User> apiResponse) {
        ...
        ((EditPhotosPresenter) this.receiver).onProfileEditSuccess(apiResponse);
    }
}
