...
final class VisitDetailsPresenter$onCancelConfirmed$2<T> implements Consumer<Throwable> {
    final /* synthetic */ VisitDetailsPresenter this$0;

    VisitDetailsPresenter$onCancelConfirmed$2(VisitDetailsPresenter visitDetailsPresenter) {
        this.this$0 = visitDetailsPresenter;
    }

    public final void accept(Throwable th) {
        ((VisitDetailsView) this.this$0.getViewState()).showMessage("Failed to cancel visit");
    }
}
