...
final class PendingInmatesPresenter$onFirstViewAttach$1<T> implements Consumer<List<? extends Inmate>> {
    final /* synthetic */ PendingInmatesPresenter this$0;

    PendingInmatesPresenter$onFirstViewAttach$1(PendingInmatesPresenter pendingInmatesPresenter) {
        this.this$0 = pendingInmatesPresenter;
    }

    public final void accept(List<Inmate> list) {
        Intrinsics.checkExpressionValueIsNotNull(list, "it");
        ((PendingInmatesView) this.this$0.getViewState()).displayInmates(list);
    }
}
