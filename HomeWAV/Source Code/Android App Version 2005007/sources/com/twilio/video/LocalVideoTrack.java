...
public class LocalVideoTrack extends VideoTrack {
    ...
    public static LocalVideoTrack create(Context context, boolean z, VideoCapturer videoCapturer2) {
        return create(context, z, videoCapturer2, (VideoConstraints) null, (String) null);
    }

    public static LocalVideoTrack create(Context context, boolean z, VideoCapturer videoCapturer2, VideoConstraints videoConstraints2) {
        return create(context, z, videoCapturer2, videoConstraints2, (String) null);
    }

    public static LocalVideoTrack create(Context context, boolean z, VideoCapturer videoCapturer2, String str) {
        return create(context, z, videoCapturer2, (VideoConstraints) null, str);
    }

    public static LocalVideoTrack create(Context context, boolean z, VideoCapturer videoCapturer2, VideoConstraints videoConstraints2, String str) {
    ...
    public long addRendererWithWants(VideoRenderer videoRenderer, boolean z) {
        ...
        do {
            ...
            if (it.hasNext()) {
                ...
                if (aspectRatio.numerator > 0 && aspectRatio.denominator > 0) {
                    if (Math.abs((((double) next.dimensions.width) / ((double) next.dimensions.height)) - (((double) aspectRatio.numerator) / ((double) aspectRatio.denominator))) < ASPECT_RATIO_TOLERANCE) {
                        z2 = true;
                    }
                    z &= z2;
                    continue;
