...
public class VideoConstraints {
    ...
    public static class Builder {
        ...
        public Builder minVideoDimensions(VideoDimensions videoDimensions) {
        ...
        public Builder aspectRatio(AspectRatio aspectRatio2) {
        ...
        public VideoConstraints build() {
            ...
            Objects.requireNonNull(videoDimensions, "MinVideoDimensions must not be null");
            Objects.requireNonNull(this.maxVideoDimensions, "MaxVideoDimensions must not be null");
            int i = this.minFps;
            int i2 = this.maxFps;
            if (i > i2) {
