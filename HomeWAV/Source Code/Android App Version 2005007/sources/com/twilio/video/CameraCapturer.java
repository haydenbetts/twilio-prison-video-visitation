...
public class CameraCapturer implements VideoCapturer {
    ...
    public static boolean isSourceAvailable(CameraSource cameraSource2) {
    ...
    static boolean isSourceAvailable(CameraCapturerFormatProvider cameraCapturerFormatProvider, CameraSource cameraSource2) {
        return cameraCapturerFormatProvider.getCameraId(cameraSource2) != -1;
    }

    public CameraCapturer(Context context2, CameraSource cameraSource2) {
        this(context2, cameraSource2, (Listener) null);
    }

    public CameraCapturer(Context context2, CameraSource cameraSource2, Listener listener2) {
        this(context2, cameraSource2, listener2, new CameraCapturerFormatProvider());
    }

    CameraCapturer(Context context2, CameraSource cameraSource2, Listener listener2, CameraCapturerFormatProvider cameraCapturerFormatProvider) {
                ...
                synchronized (CameraCapturer.this.stateLock) {
                    if (CameraCapturer.this.state == State.STARTING) {
                        ...
                        if (CameraCapturer.this.cameraParameterUpdater != null) {
                            ...
                            cameraCapturer2.lambda$updateCameraParameters$0$CameraCapturer(cameraCapturer2.cameraParameterUpdater);
        ...
        this.cameraSwitchHandler = new CameraVideoCapturer.CameraSwitchHandler() {
            public void onCameraSwitchDone(boolean z) {
                synchronized (CameraCapturer.this) {
                    CameraCapturer cameraCapturer = CameraCapturer.this;
                    CameraSource unused = cameraCapturer.cameraSource = cameraCapturer.cameraSource == CameraSource.FRONT_CAMERA ? CameraSource.BACK_CAMERA : CameraSource.FRONT_CAMERA;
                }
                if (CameraCapturer.this.listener != null) {
    ...
    public synchronized void switchCamera() {
        ...
        synchronized (this.stateLock) {
            if (this.state != State.IDLE) {
                ...
                if (listener2 != null) {
                    listener2.onCameraSwitched();
                }
            }
        }
    }

    public synchronized boolean updateCameraParameters(CameraParameterUpdater cameraParameterUpdater2) {
        synchronized (this.stateLock) {
            if (this.state != State.RUNNING) {
                ...
                boolean post = this.camera1Session.cameraThreadHandler.post(new Runnable(cameraParameterUpdater2) {
                    public final /* synthetic */ CameraParameterUpdater f$1;
                    ...
                    public final void run() {
                        CameraCapturer.this.lambda$updateCameraParameters$0$CameraCapturer(this.f$1);
                    }
                });
                return post;
            } else {
    ...
    public synchronized boolean takePicture(PictureListener pictureListener2) {
        ...
        synchronized (this.stateLock) {
            if (this.state != State.RUNNING) {
                ...
                boolean post = this.camera1Session.cameraThreadHandler.post(new Runnable(Util.createCallbackHandler(), pictureListener2) {
                    ...
                    public final /* synthetic */ CameraCapturer.PictureListener f$2;
                    ...
                    public final void run() {
                        CameraCapturer.this.lambda$takePicture$1$CameraCapturer(this.f$1, this.f$2);
                    }
                });
                return post;
            } else {
    ...
    private List<VideoFormat> defaultFormats() {
        ...
        arrayList.add(new VideoFormat(new VideoDimensions(640, 480), 30, VideoPixelFormat.NV21));
        return arrayList;
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: updateCameraParametersOnCameraThread */
    public void lambda$updateCameraParameters$0$CameraCapturer(CameraParameterUpdater cameraParameterUpdater2) {
        synchronized (this.stateLock) {
            if (this.state == State.RUNNING) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: takePictureOnCameraThread */
    public void lambda$takePicture$1$CameraCapturer(Handler handler, PictureListener pictureListener2) {
        synchronized (this.stateLock) {
            if (this.state == State.RUNNING) {
                this.camera1Session.checkIsOnCameraThread();
                this.camera1Session.camera.takePicture(new Camera.ShutterCallback(handler, pictureListener2) {
                    public final /* synthetic */ Handler f$0;
                    public final /* synthetic */ CameraCapturer.PictureListener f$1;
                    ...
                    public final /* synthetic */ Camera.CameraInfo f$1;
                    public final /* synthetic */ Handler f$2;
                    public final /* synthetic */ CameraCapturer.PictureListener f$3;
                    ...
                    public final void onPictureTaken(byte[] bArr, Camera camera) {
                        CameraCapturer.this.lambda$takePictureOnCameraThread$4$CameraCapturer(this.f$1, this.f$2, this.f$3, bArr, camera);
                    }
                });
            } else {
    ...
    public /* synthetic */ void lambda$takePictureOnCameraThread$4$CameraCapturer(Camera.CameraInfo cameraInfo, Handler handler, PictureListener pictureListener2, byte[] bArr, Camera camera) {
        handler.post(new Runnable(pictureListener2, alignPicture(cameraInfo, bArr)) {
            public final /* synthetic */ CameraCapturer.PictureListener f$1;
            ...
            public final void run() {
                CameraCapturer.this.lambda$null$3$CameraCapturer(this.f$1, this.f$2);
            }
        });
        synchronized (this.stateLock) {
            if (this.state == State.RUNNING) {
    ...
    public /* synthetic */ void lambda$null$3$CameraCapturer(PictureListener pictureListener2, byte[] bArr) {
