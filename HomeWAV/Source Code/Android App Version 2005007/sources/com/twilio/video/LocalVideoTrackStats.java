...
public class LocalVideoTrackStats extends LocalTrackStats {
    ...
    LocalVideoTrackStats(String str, int i, String str2, String str3, double d, long j, int i2, long j2, VideoDimensions videoDimensions, VideoDimensions videoDimensions2, int i3, int i4) {
