...
public class I420Frame {
    ...
    public String toString() {
        return this.width + "x" + this.height + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + this.yuvStrides[0] + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + this.yuvStrides[1] + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + this.yuvStrides[2];
    }
}
