...
public class Mask {
    ...
    public Result apply(CaretString caretString, boolean z) {
    ...
    public CaretStringIterator makeIterator(CaretString caretString) {
        Intrinsics.checkParameterIsNotNull(caretString, "text");
        return new CaretStringIterator(caretString, 0, 2, (DefaultConstructorMarker) null);
    }
