...
class SignallingServiceArgs extends SignallingInputArgs {
    String __channel;
    byte[] __dataBytes;
    String __dataJson;
    private IAction1<SignallingServiceFailureArgs> _onFailure;
    private IAction1<SignallingServiceSuccessArgs> _onSuccess;
    ...
    public IAction1<SignallingServiceFailureArgs> getOnFailure() {
        return this._onFailure;
    }

    public IAction1<SignallingServiceSuccessArgs> getOnSuccess() {
    ...
    public void setOnFailure(IAction1<SignallingServiceFailureArgs> iAction1) {
        this._onFailure = iAction1;
    }

    public void setOnSuccess(IAction1<SignallingServiceSuccessArgs> iAction1) {
    ...
    public SignallingServiceArgs() {
    }

    public SignallingServiceArgs(String str, byte[] bArr) {
        this(str, bArr, (String) null);
    }

    public SignallingServiceArgs(String str, byte[] bArr, String str2) {
        setChannel(str);
        setDataBytes(bArr);
        setTag(str2);
    }

    public SignallingServiceArgs(String str, String str2) {
        this(str, str2, (String) null);
    }

    public SignallingServiceArgs(String str, String str2, String str3) {
        setChannel(str);
        setDataJson(str2);
        setTag(str3);
    }
