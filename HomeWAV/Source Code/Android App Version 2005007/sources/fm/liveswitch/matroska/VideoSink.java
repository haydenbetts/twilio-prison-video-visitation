...
public class VideoSink extends fm.liveswitch.VideoSink {
    ...
    private void initialize(String str) {
        ...
        super.addOnDisabledChange(new IActionDelegate0() {
            public String getId() {
                return "fm.liveswitch.matroska.VideoSink.videoSink_OnDisabledChange";
            }
    ...
    private void openRecorder(VideoFrame videoFrame) {
        VideoRecorder videoRecorder = new VideoRecorder(getPath(), (VideoFormat) super.getInputFormat());
    ...
    public VideoSink(String str, VideoFormat videoFormat) {
        super(videoFormat);
        this.__onFileClose = new ArrayList();
        this.__onFileOpen = new ArrayList();
        this._onFileClose = null;
    ...
    public VideoSink(String str, IVideoOutput iVideoOutput) {
        this(str, (VideoFormat) iVideoOutput.getOutputFormat());
