...
class SignallingServiceFailureArgs extends SignallingFailureArgs {
    private String __channel;
    private byte[] __dataBytes;
    private String __dataJson;
    private FailureSource _source;
    ...
    public void setSource(FailureSource failureSource) {
        this._source = failureSource;
    }

    public SignallingServiceFailureArgs(String str, String str2, byte[] bArr) {
        this.__channel = str;
