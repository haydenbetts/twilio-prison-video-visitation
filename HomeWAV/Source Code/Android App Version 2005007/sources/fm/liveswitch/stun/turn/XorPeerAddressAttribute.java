...
public class XorPeerAddressAttribute extends Attribute {
    ...
    public int getTypeValue() {
        return Attribute.getXorPeerAddressType();
    }
    ...
    public static XorPeerAddressAttribute readValueFrom(DataBuffer dataBuffer, int i, DataBuffer dataBuffer2) {
        ...
        xorPeerAddressAttribute.setTransactionId(dataBuffer2);
        xorPeerAddressAttribute.setPort(Attribute.readXorPort(dataBuffer, i + 2, dataBuffer2));
        xorPeerAddressAttribute.setIPAddress(Attribute.readXorIPAddress(dataBuffer, i + 4, readAddressType, dataBuffer2));
    ...
    public String toString() {
        return StringExtensions.format("XOR-PEER-ADDRESS {0}:{1}", getIPAddress(), IntegerExtensions.toString(Integer.valueOf(getPort())));
    }
    ...
    private XorPeerAddressAttribute() {
    }

    public XorPeerAddressAttribute(String str, int i, DataBuffer dataBuffer) {
