...
public class DateUtils {
    ...
    public static CharSequence getRelativeTimeSpanString(Context context, ReadableInstant readableInstant) {
        return getRelativeTimeSpanString(context, readableInstant, (int) avcodec.AV_CODEC_ID_PCM_F32BE);
    }
    ...
    public static CharSequence getRelativeTimeSpanString(Context context, ReadableInstant readableInstant, boolean z) {
        ...
        if (Days.daysBetween((ReadablePartial) now, (ReadablePartial) localDate).getDays() == 0) {
            ...
            str = formatDateRange(context, readableInstant, readableInstant, (int) avcodec.AV_CODEC_ID_PCM_S24DAUD);
            i = R.string.joda_time_android_preposition_for_date;
        }
        if (!z) {
            return str;
    ...
    public static CharSequence getRelativeDateTimeString(Context context, ReadableInstant readableInstant, ReadablePeriod readablePeriod, int i) {
        ...
        if (!duration.isLongerThan(durationTo)) {
            return resources.getString(R.string.joda_time_android_relative_time, new Object[]{getRelativeTimeSpanString(context, readableInstant, i), formatDateRange});
        }
        return resources.getString(R.string.joda_time_android_date_time, new Object[]{getRelativeTimeSpanString(context, readableInstant, false), formatDateRange});
    }
