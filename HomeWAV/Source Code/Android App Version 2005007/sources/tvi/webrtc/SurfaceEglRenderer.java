...
public class SurfaceEglRenderer extends EglRenderer implements SurfaceHolder.Callback {
    ...
    private void updateFrameDimensionsAndReportEvents(tvi.webrtc.VideoRenderer.I420Frame r6) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r5.isRenderingPaused     // Catch:{ all -> 0x007b }
            if (r1 == 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x007b }
            return
        L_0x0009:
            boolean r1 = r5.isFirstFrameRendered     // Catch:{ all -> 0x007b }
            if (r1 != 0) goto L_0x001c
            r1 = 1
            r5.isFirstFrameRendered = r1     // Catch:{ all -> 0x007b }
            java.lang.String r1 = "Reporting first rendered frame."
            r5.logD(r1)     // Catch:{ all -> 0x007b }
            tvi.webrtc.RendererCommon$RendererEvents r1 = r5.rendererEvents     // Catch:{ all -> 0x007b }
            if (r1 == 0) goto L_0x001c
            r1.onFirstFrameRendered()     // Catch:{ all -> 0x007b }
        L_0x001c:
            int r1 = r5.rotatedFrameWidth     // Catch:{ all -> 0x007b }
            int r2 = r6.rotatedWidth()     // Catch:{ all -> 0x007b }
            if (r1 != r2) goto L_0x0032
            int r1 = r5.rotatedFrameHeight     // Catch:{ all -> 0x007b }
            int r2 = r6.rotatedHeight()     // Catch:{ all -> 0x007b }
            if (r1 != r2) goto L_0x0032
            int r1 = r5.frameRotation     // Catch:{ all -> 0x007b }
            int r2 = r6.rotationDegree     // Catch:{ all -> 0x007b }
        ...
        L_0x0032:
            ...
            int r2 = r6.width     // Catch:{ all -> 0x007b }
            r1.append(r2)     // Catch:{ all -> 0x007b }
            java.lang.String r2 = "x"
            r1.append(r2)     // Catch:{ all -> 0x007b }
            int r2 = r6.height     // Catch:{ all -> 0x007b }
            r1.append(r2)     // Catch:{ all -> 0x007b }
            ...
            int r2 = r6.width     // Catch:{ all -> 0x007b }
            int r3 = r6.height     // Catch:{ all -> 0x007b }
            int r4 = r6.rotationDegree     // Catch:{ all -> 0x007b }
            r1.onFrameResolutionChanged(r2, r3, r4)     // Catch:{ all -> 0x007b }
        L_0x0069:
            int r1 = r6.rotatedWidth()     // Catch:{ all -> 0x007b }
            r5.rotatedFrameWidth = r1     // Catch:{ all -> 0x007b }
            int r1 = r6.rotatedHeight()     // Catch:{ all -> 0x007b }
            r5.rotatedFrameHeight = r1     // Catch:{ all -> 0x007b }
            int r6 = r6.rotationDegree     // Catch:{ all -> 0x007b }
            r5.frameRotation = r6     // Catch:{ all -> 0x007b }
        L_0x0079:
            monitor-exit(r0)     // Catch:{ all -> 0x007b }
            return
        L_0x007b:
    ...
    private void updateFrameDimensionsAndReportEvents(tvi.webrtc.VideoFrame r6) {
        ...
        L_0x0009:
            ...
            tvi.webrtc.RendererCommon$RendererEvents r1 = r5.rendererEvents     // Catch:{ all -> 0x009b }
            if (r1 == 0) goto L_0x001c
        ...
        L_0x0034:
            ...
            tvi.webrtc.VideoFrame$Buffer r2 = r6.getBuffer()     // Catch:{ all -> 0x009b }
            ...
            tvi.webrtc.VideoFrame$Buffer r2 = r6.getBuffer()     // Catch:{ all -> 0x009b }
            int r2 = r2.getWidth()     // Catch:{ all -> 0x009b }
            tvi.webrtc.VideoFrame$Buffer r3 = r6.getBuffer()     // Catch:{ all -> 0x009b }
