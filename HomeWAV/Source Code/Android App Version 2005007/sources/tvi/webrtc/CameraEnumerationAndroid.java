...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size[]{new Size(160, 120), new Size(240, 160), new Size(DimensionsKt.XHDPI, 240), new Size(400, 240), new Size(480, DimensionsKt.XHDPI), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(800, 600), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, 600), new Size(1280, VideoDimensions.HD_720P_VIDEO_HEIGHT), new Size(1280, 1024), new Size(VideoDimensions.HD_1080P_VIDEO_WIDTH, 1080), new Size(VideoDimensions.HD_1080P_VIDEO_WIDTH, 1440), new Size(2560, 1440), new Size(3840, 2160)}));
    ...
    public static class CaptureFormat {
        ...
        public static class FramerateRange {
            ...
            public String toString() {
                return "[" + (((float) this.min) / 1000.0f) + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + (((float) this.max) / 1000.0f) + "]";
            }
            ...
            public int hashCode() {
                return (this.min * avcodec.AV_CODEC_ID_PCM_S16BE) + 1 + this.max;
            }
        }
