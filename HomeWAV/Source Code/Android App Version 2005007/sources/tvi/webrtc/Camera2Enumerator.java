...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public Camera2Enumerator(Context context2) {
        ...
        this.cameraManager = (CameraManager) context2.getSystemService(AvatarUpdaterDialog.CAMERA);
    }
    ...
    public static boolean isSupported(Context context2) {
        ...
        CameraManager cameraManager2 = (CameraManager) context2.getSystemService(AvatarUpdaterDialog.CAMERA);
        try {
    ...
    static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(Context context2, String str) {
        return getSupportedFormats((CameraManager) context2.getSystemService(AvatarUpdaterDialog.CAMERA), str);
    }
