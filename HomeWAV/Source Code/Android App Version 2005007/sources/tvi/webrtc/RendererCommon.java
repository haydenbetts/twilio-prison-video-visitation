...
public class RendererCommon {
    ...
    /* renamed from: tvi.webrtc.RendererCommon$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                tvi.webrtc.RendererCommon$ScalingType[] r0 = tvi.webrtc.RendererCommon.ScalingType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$webrtc$RendererCommon$ScalingType = r0
                tvi.webrtc.RendererCommon$ScalingType r1 = tvi.webrtc.RendererCommon.ScalingType.SCALE_ASPECT_FIT     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$org$webrtc$RendererCommon$ScalingType     // Catch:{ NoSuchFieldError -> 0x001d }
                tvi.webrtc.RendererCommon$ScalingType r1 = tvi.webrtc.RendererCommon.ScalingType.SCALE_ASPECT_FILL     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$org$webrtc$RendererCommon$ScalingType     // Catch:{ NoSuchFieldError -> 0x0028 }
                tvi.webrtc.RendererCommon$ScalingType r1 = tvi.webrtc.RendererCommon.ScalingType.SCALE_ASPECT_BALANCED     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: tvi.webrtc.RendererCommon.AnonymousClass1.<clinit>():void");
        }
    }
