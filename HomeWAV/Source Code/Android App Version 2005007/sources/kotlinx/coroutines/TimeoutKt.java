...
public final class TimeoutKt {
    ...
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L_0x0019:
            ...
            long r8 = r0.J$0
            boolean r8 = r10 instanceof kotlin.Result.Failure     // Catch:{ TimeoutCancellationException -> 0x003b }
            if (r8 != 0) goto L_0x0036
            goto L_0x007f
        L_0x0036:
            kotlin.Result$Failure r10 = (kotlin.Result.Failure) r10     // Catch:{ TimeoutCancellationException -> 0x003b }
            java.lang.Throwable r8 = r10.exception     // Catch:{ TimeoutCancellationException -> 0x003b }
            throw r8     // Catch:{ TimeoutCancellationException -> 0x003b }
        L_0x003b:
            r8 = move-exception
            goto L_0x0082
        L_0x003d:
        ...
        L_0x0050:
            ...
            r10.element = r2
            r0.J$0 = r7     // Catch:{ TimeoutCancellationException -> 0x0080 }
            r0.L$0 = r9     // Catch:{ TimeoutCancellationException -> 0x0080 }
            r0.L$1 = r10     // Catch:{ TimeoutCancellationException -> 0x0080 }
            r0.label = r3     // Catch:{ TimeoutCancellationException -> 0x0080 }
            r2 = r0
            kotlin.coroutines.Continuation r2 = (kotlin.coroutines.Continuation) r2     // Catch:{ TimeoutCancellationException -> 0x0080 }
            kotlinx.coroutines.TimeoutCoroutine r3 = new kotlinx.coroutines.TimeoutCoroutine     // Catch:{ TimeoutCancellationException -> 0x0080 }
            r3.<init>(r7, r2)     // Catch:{ TimeoutCancellationException -> 0x0080 }
            r10.element = r3     // Catch:{ TimeoutCancellationException -> 0x0080 }
            java.lang.Object r7 = setupTimeout(r3, r9)     // Catch:{ TimeoutCancellationException -> 0x0080 }
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ TimeoutCancellationException -> 0x0080 }
            if (r7 != r8) goto L_0x007b
            kotlin.coroutines.Continuation r0 = (kotlin.coroutines.Continuation) r0     // Catch:{ TimeoutCancellationException -> 0x0080 }
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch:{ TimeoutCancellationException -> 0x0080 }
        L_0x007b:
