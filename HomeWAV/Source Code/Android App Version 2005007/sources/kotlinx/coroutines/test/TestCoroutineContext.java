...
public final class TestCoroutineContext implements CoroutineContext {
    ...
    public final void post(Runnable runnable) {
        ...
        long j = this.counter;
        this.counter = 1 + j;
        threadSafeHeap.addLast(new TimedRunnable(runnable, j, 0, 4, (DefaultConstructorMarker) null));
    }
    ...
    private final class Dispatcher extends CoroutineDispatcher implements Delay, EventLoop {
        ...
        public void scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
            ...
            TimedRunnable unused = TestCoroutineContext.this.postDelayed(new TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$$inlined$Runnable$1(this, cancellableContinuation), j);
        }
