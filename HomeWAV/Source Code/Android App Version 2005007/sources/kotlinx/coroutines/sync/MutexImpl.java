        ...
        while (true) {
            ...
            if (obj3 instanceof Empty) {
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    ...
                    if (_state$FU.compareAndSet(this, obj3, obj2 == null ? MutexKt.EmptyLocked : new Empty(obj2))) {
                ...
                if (lockedQueue.owner != obj2) {
                    ...
                    LockFreeLinkedListNode.CondAddOp mutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutine$lambda$1 = new MutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutine$lambda$1(lockFreeLinkedListNode, lockFreeLinkedListNode, obj3, cancellableContinuation, lockCont, this, obj);
                    while (true) {
