                ...
                if (delegate != null) {
                    ...
                    if (job != null) {
                        if (!job.isActive()) {
                            ...
                            continuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(job.getCancellationException())));
                    ...
                    if (exceptionalResult != null) {
                        ...
                        continuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(exceptionalResult)));
                    } else {
