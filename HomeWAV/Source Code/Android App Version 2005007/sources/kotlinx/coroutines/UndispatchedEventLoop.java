...
public final class UndispatchedEventLoop {
    ...
    public static final class EventLoop {
        ...
        public EventLoop() {
            this(false, (ArrayQueue) null, 3, (DefaultConstructorMarker) null);
        }

        public static /* synthetic */ EventLoop copy$default(EventLoop eventLoop, boolean z, ArrayQueue<Runnable> arrayQueue, int i, Object obj) {
            if ((i & 1) != 0) {
    ...
    public final boolean execute(DispatchedContinuation<?> dispatchedContinuation, Object obj, int i, boolean z, Function0<Unit> function0) {
        Intrinsics.checkParameterIsNotNull(dispatchedContinuation, "continuation");
        Intrinsics.checkParameterIsNotNull(function0, "block");
        EventLoop eventLoop = (EventLoop) threadLocalEventLoop.get();
        if (!eventLoop.isActive) {
