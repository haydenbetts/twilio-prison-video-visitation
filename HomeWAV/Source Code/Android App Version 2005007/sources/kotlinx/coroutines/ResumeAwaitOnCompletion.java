...
final class ResumeAwaitOnCompletion<T> extends JobNode<JobSupport> {
    ...
    public ResumeAwaitOnCompletion(JobSupport jobSupport, AbstractContinuation<? super T> abstractContinuation) {
        super(jobSupport);
    ...
    public void invoke(Throwable th) {
        ...
        if (!(!(state$kotlinx_coroutines_core instanceof Incomplete))) {
            ...
            this.continuation.resumeWith(Result.m3constructorimpl(state$kotlinx_coroutines_core));
        }
    }
