...
public final class FlowableKt {
    ...
    public static final <T, R> io.reactivex.Flowable<kotlin.Pair<T, R>> combineLatest(io.reactivex.Flowable<T> r2, io.reactivex.Flowable<R> r3) {
        /*
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final <T, R, U> io.reactivex.Flowable<kotlin.Triple<T, R, U>> combineLatest(io.reactivex.Flowable<T> r2, io.reactivex.Flowable<R> r3, io.reactivex.Flowable<U> r4) {
        /*
            java.lang.String r0 = "$receiver"
            kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(r2, r0)
