...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size[]{new Size(160, 120), new Size(240, 160), new Size(320, 240), new Size(400, 240), new Size(480, 320), new Size(VideoDimensions.VGA_VIDEO_WIDTH, 360), new Size(VideoDimensions.VGA_VIDEO_WIDTH, 480), new Size(768, 480), new Size(854, 480), new Size(VideoDimensions.WVGA_VIDEO_WIDTH, 600), new Size(960, VideoDimensions.HD_540P_VIDEO_HEIGHT), new Size(960, VideoDimensions.VGA_VIDEO_WIDTH), new Size(1024, 576), new Size(1024, 600), new Size(1280, VideoDimensions.HD_720P_VIDEO_HEIGHT), new Size(1280, 1024), new Size(VideoDimensions.HD_1080P_VIDEO_WIDTH, 1080), new Size(VideoDimensions.HD_1080P_VIDEO_WIDTH, VideoDimensions.HD_S1080P_VIDEO_WIDTH), new Size(2560, VideoDimensions.HD_S1080P_VIDEO_WIDTH), new Size(3840, 2160)}));
