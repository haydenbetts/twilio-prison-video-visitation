...
public interface VideoCapturer {
    ...
    public interface CapturerObserver {
        ...
        public final /* synthetic */ class CC {
            @Deprecated
            public static void $default$onByteBufferFrameCaptured(CapturerObserver capturerObserver, byte[] bArr, int i, int i2, int i3, long j) {
                throw new UnsupportedOperationException("Deprecated and not implemented.");
            }

            @Deprecated
            public static void $default$onTextureFrameCaptured(CapturerObserver capturerObserver, int i, int i2, int i3, float[] fArr, int i4, long j) {
                throw new UnsupportedOperationException("Deprecated and not implemented.");
            }
        }
    }
