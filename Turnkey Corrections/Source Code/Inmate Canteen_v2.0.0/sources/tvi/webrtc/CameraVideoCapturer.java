    ...
    public static class CameraStatistics {
        ...
        private final Runnable cameraObserver = new Runnable() {
            public void run() {
                ...
                CameraStatistics.this.surfaceTextureHelper.getHandler().postDelayed(this, TestUtils.TWO_SECONDS);
            }
        };
        ...
        public CameraStatistics(SurfaceTextureHelper surfaceTextureHelper2, CameraEventsHandler cameraEventsHandler) {
            if (surfaceTextureHelper2 != null) {
                ...
                surfaceTextureHelper2.getHandler().postDelayed(this.cameraObserver, TestUtils.TWO_SECONDS);
                return;
            }
