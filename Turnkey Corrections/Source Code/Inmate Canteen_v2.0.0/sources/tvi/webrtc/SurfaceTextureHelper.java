...
public class SurfaceTextureHelper {
    ...
    public VideoFrame.I420Buffer textureToYuv(VideoFrame.TextureBuffer textureBuffer) {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, (Runnable) new Runnable(i420BufferArr, textureBuffer) {
            ...
            private final /* synthetic */ VideoFrame.TextureBuffer f$2;
            ...
            public final void run() {
                SurfaceTextureHelper.lambda$textureToYuv$1(SurfaceTextureHelper.this, this.f$1, this.f$2);
            }
        });
        return i420BufferArr[0];
    }

    public static /* synthetic */ void lambda$textureToYuv$1(SurfaceTextureHelper surfaceTextureHelper, VideoFrame.I420Buffer[] i420BufferArr, VideoFrame.TextureBuffer textureBuffer) {
        if (surfaceTextureHelper.yuvConverter == null) {
            surfaceTextureHelper.yuvConverter = new YuvConverter();
        }
        i420BufferArr[0] = surfaceTextureHelper.yuvConverter.convert(textureBuffer);
    }
