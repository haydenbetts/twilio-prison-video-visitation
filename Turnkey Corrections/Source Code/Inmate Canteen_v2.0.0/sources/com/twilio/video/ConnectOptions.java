...
public class ConnectOptions {
    ...
    static void checkAudioCodecs(@Nullable List<AudioCodec> list) {
        if (list != null) {
    ...
    static void checkVideoCodecs(@Nullable List<VideoCodec> list) {
        if (list != null) {
    ...
    static void checkAudioTracksReleased(@Nullable List<LocalAudioTrack> list) {
        if (list != null) {
    ...
    static void checkVideoTracksReleased(@Nullable List<LocalVideoTrack> list) {
        if (list != null) {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder videoTracks(@NonNull List<LocalVideoTrack> list) {
        ...
        @NonNull
        public Builder dataTracks(@NonNull List<LocalDataTrack> list) {
        ...
        @NonNull
        public Builder iceOptions(@NonNull IceOptions iceOptions2) {
        ...
        @NonNull
        public Builder networkQualityConfiguration(@NonNull NetworkQualityConfiguration networkQualityConfiguration2) {
        ...
        @NonNull
        public Builder preferVideoCodecs(@NonNull List<VideoCodec> list) {
            Preconditions.checkNotNull(list);
        ...
        @NonNull
        public Builder encodingParameters(@NonNull EncodingParameters encodingParameters2) {
        ...
        /* access modifiers changed from: package-private */
        @VisibleForTesting(otherwise = 5)
        public Builder mediaFactory(@Nullable MediaFactory mediaFactory2) {
