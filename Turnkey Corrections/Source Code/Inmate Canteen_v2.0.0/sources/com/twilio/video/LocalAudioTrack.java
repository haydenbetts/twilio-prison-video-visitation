...
public class LocalAudioTrack extends AudioTrack {
    ...
    @Nullable
    public static LocalAudioTrack create(@NonNull Context context, boolean z) {
        return create(context, z, (AudioOptions) null, (String) null);
    }

    @Nullable
    public static LocalAudioTrack create(@NonNull Context context, boolean z, @Nullable AudioOptions audioOptions) {
        return create(context, z, audioOptions, (String) null);
    }

    @Nullable
    public static LocalAudioTrack create(@NonNull Context context, boolean z, @Nullable String str) {
        return create(context, z, (AudioOptions) null, str);
    }

    @Nullable
    public static LocalAudioTrack create(@NonNull Context context, boolean z, @Nullable AudioOptions audioOptions, @Nullable String str) {
    ...
    LocalAudioTrack(long j, @NonNull String str, @NonNull String str2, boolean z, Context context) {
        super(j, z, str2);
