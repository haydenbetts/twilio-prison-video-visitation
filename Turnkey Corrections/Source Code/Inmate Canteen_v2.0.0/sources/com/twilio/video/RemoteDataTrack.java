...
public class RemoteDataTrack extends DataTrack {
    ...
    private final Listener dataTrackListenerProxy = new Listener() {
        public void onMessage(@NonNull RemoteDataTrack remoteDataTrack, @NonNull ByteBuffer byteBuffer) {
            ...
            synchronized (RemoteDataTrack.this) {
                if (RemoteDataTrack.this.handler != null) {
                    RemoteDataTrack.this.handler.post(new Runnable(remoteDataTrack, byteBuffer) {
                        private final /* synthetic */ RemoteDataTrack f$1;
                        private final /* synthetic */ ByteBuffer f$2;
                        ...
                        public final void run() {
                            RemoteDataTrack.AnonymousClass1.lambda$onMessage$0(RemoteDataTrack.AnonymousClass1.this, this.f$1, this.f$2);
                        }
                    });
                }
            }
        ...
        public static /* synthetic */ void lambda$onMessage$0(AnonymousClass1 r3, RemoteDataTrack remoteDataTrack, ByteBuffer byteBuffer) {
            synchronized (RemoteDataTrack.this) {
        ...
        public void onMessage(@NonNull RemoteDataTrack remoteDataTrack, @NonNull String str) {
            ...
            synchronized (RemoteDataTrack.this) {
                if (RemoteDataTrack.this.handler != null) {
                    RemoteDataTrack.this.handler.post(new Runnable(remoteDataTrack, str) {
                        ...
                        public final void run() {
                            RemoteDataTrack.AnonymousClass1.lambda$onMessage$1(RemoteDataTrack.AnonymousClass1.this, this.f$1, this.f$2);
                        }
                    });
                }
            }
        ...
        public static /* synthetic */ void lambda$onMessage$1(AnonymousClass1 r3, RemoteDataTrack remoteDataTrack, String str) {
            synchronized (RemoteDataTrack.this) {
    ...
    RemoteDataTrack(boolean z, boolean z2, boolean z3, int i, int i2, @NonNull String str, @NonNull String str2, long j) {
